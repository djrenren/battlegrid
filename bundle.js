 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const gt=vt(class extends pt{constructor(t){var i;if(super(t),t.type!==dt||"style"!==t.name||(null===(i=t.strings)||void 0===i?void 0:i.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((i,s)=>{const e=t[s];return null==e?i:i+`${s=s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${e};`}),"")}update(t,[i]){const{style:s}=t.element;if(void 0===this.ct){this.ct=new Set;for(const t in i)this.ct.add(t);return this.render(i)}this.ct.forEach((t=>{null==i[t]&&(this.ct.delete(t),t.includes("-")?s.removeProperty(t):s[t]="")}));for(const t in i){const e=i[t];null!=e&&(this.ct.add(t),t.includes("-")?s.setProperty(t,e):s[t]=e)}return P}}),ft=t=>t.isPrimary&&("touch"===t.pointerType||t.pressure>0),wt=t=>"mouse"===t.pointerType&&1===t.buttons&&t.pressure>0,bt=t=>"touch"!==t.pointerType&&t.isPrimary&&t.pressure>0,mt=t=>{t.preventDefault(),t.stopPropagation()},yt=(t,i)=>new CustomEvent(t,{detail:i}),$t=(t,i)=>[t[0]+i[0],t[1]+i[1]],kt=(t,i)=>$t(t,[i,i]),xt=(t,i)=>[t[0]-i[0],t[1]-i[1]],_t=(t,i)=>[t[0]*i,t[1]*i],St=(t,i)=>[t[0]*i[0],t[1]*i[1]],Ct=(t,i)=>[t[0]/i[0],t[1]/i[1]],Mt=(t,i)=>[t[0]/i,t[1]/i],At=(t,i)=>t[0]>i[0]&&t[1]>i[1],Tt=(t,i)=>t[0]<i[0]&&t[1]<i[1],Et=(t,i)=>[Math.max(t[0],i[0]),Math.max(t[1],i[1])],Rt=(t,i)=>[Math.min(t[0],i[0]),Math.min(t[1],i[1])],Ut=(t,i,s)=>Et(t,Rt(i,s)),zt=(t,i)=>t[0]===i[0]&&t[1]===i[1];let Ot=class extends it{constructor(){super(...arguments),this.scale=1,this.c_dim=[0,0],this.v_dim=[0,0],this.v_loc=[0,0],this._scrollPos=[0,0],this.smooth=0,this.#t=0,this.#i=[0,0],this.#s=new ResizeObserver((t=>{for(let i of t)switch(i.target){case this.surface:this.v_dim=[i.contentRect.width,i.contentRect.height];const t=this.getBoundingClientRect();this.v_loc=[t.x,t.y],this.smooth=0;break;case this.#e:this.c_dim=[this.#e.width.baseVal.value,this.#e.height.baseVal.value]}})),this.#o=t=>{t.ctrlKey&&("="===t.key?(mt(t),this.smooth=200,this._performZoom(this.coordToLocal(Mt($t(this.v_loc,this.v_dim),2)),.2*this.scale)):"-"===t.key?(mt(t),this.smooth=200,this._performZoom(this.coordToLocal(Mt($t(this.v_loc,this.v_dim),2)),-.2*this.scale)):"0"===t.key&&(this.smooth=100,this.#n()))},this.#r=[0,0],this.#h=t=>{mt(t),t.target.setPointerCapture(t.pointerId),this.#r=[t.clientX,t.clientY]},this.#l=(t,i,s,e)=>{this.smooth=0;let o=this.#a,n=this.#r;this.#r=[t.clientX,t.clientY],this.#a=[i?o[0]+e*(this.#r[0]-n[0]):o[0],s?o[1]+e*(this.#r[1]-n[1]):o[1]]},this.#c=t=>{t.target.releasePointerCapture(t.pointerId)},this._touchdragstart=t=>{t.isPrimary&&"touch"===t.pointerType&&this.#h(t)},this._touchdragmove=t=>{t.isPrimary&&"touch"===t.pointerType&&this.#l(t,!0,!0,-1)},this._touchdragend=t=>{t.isPrimary&&"touch"===t.pointerType&&this.#c(t)}}#e;get#a(){return Et([0,0],Rt(this._scrollPos,xt(_t(this.c_dim,this.scale),this.v_dim)))}set#a(t){const i=this._scrollPos;this._scrollPos=t,this.requestUpdate("#scrollPos",i)}get offset(){return Et([0,0],_t(xt(this.v_dim,_t(this.c_dim,this.scale)),.5)).map((t=>t))}render(){const t=this.offset,i=this.#a;let s=!1,e=!1;this.v_dim&&this.c_dim&&(s=this.v_dim[1]<this.c_dim[1]*this.scale,e=this.v_dim[0]<this.c_dim[0]*this.scale);const o=Ct(St(this.v_dim,this.v_dim),_t(this.c_dim,this.scale)),n=Ct(St(i,this.v_dim),_t(this.c_dim,this.scale));return O`<style>:host,:root{--scale:${this.scale}}::slotted(svg){transform:translate(${t[0]-i[0]}px,${t[1]-i[1]}px) scale(var(--scale))}*,::slotted(svg){transition-duration:${this.smooth+"ms"}}</style><div id="touch-surface" @wheel="${this._wheel}" @pointerdown="${this._touchdragstart}" @pointermove="${this._touchdragmove}" @pointerup="${this._touchdragend}" @gesturestart="${this._gesturestart}" @gesturechange="${this._gesturechange}"><div id="bg" part="background"></div><slot @slotchange="${this.handleSlotchange}"></slot><div part="bar" class="bottombar" style="${gt({transform:`translate(${n[0]}px, 0)`,width:`${o[0]}px`,display:e?"block":"none"})}" @pointerdown="${this.#d}" @pointermove="${this.#u}" @pointerup="${this.#v}"></div><div part="bar" class="rightbar" style="${gt({transform:`translate(0, ${n[1]}px)`,height:`${o[1]}px`,display:s?"block":"none"})}" @pointerdown="${this.#d}" @pointermove="${this.#p}" @pointerup="${this.#v}"></div></div>`}#d(t){bt(t)&&this.#h(t)}#u(t){bt(t)&&this.#l(t,!0,!1,this.c_dim[0]*this.scale/this.v_dim[0])}#p(t){bt(t)&&this.#l(t,!1,!0,this.c_dim[1]*this.scale/this.v_dim[1])}#v(t,i){this.#c(t)}_wheel(t){mt(t);const i=t.deltaMode===WheelEvent.DOM_DELTA_LINE?10:1;if(t.ctrlKey){const s=Math.min(50,Math.max(-50,-t.deltaY*i)),e=.005*s*this.scale;this.smooth=50===Math.abs(s)?300:0,this._performZoom(this.coordToLocal([t.clientX,t.clientY]),e)}else{const s=_t([t.deltaX,t.deltaY],i);this.smooth=2*(Math.abs(s[0])+Math.abs(s[1])),this.smooth=0,this.#a=$t(s,this.#a)}}#t;#i;_gesturestart(t){this.#i=this.coordToLocal([t.clientX,t.clientY]),this.#t=1,mt(t)}_gesturechange(t){mt(t),this._performZoom(this.#i,this.scale*(t.scale-this.#t)*1.5),this.#t=t.scale}_performZoom(t,i){let s=Math.min(1,Math.max(.2,this.scale+i)),e=s-this.scale;this.#a=$t(_t(t,e),this.#a),this.scale=s}#s;firstUpdated(){this.#s.observe(this.surface)}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.#o)}disconnectedCallback(){super.disconnectedCallback(),this.#s.disconnect(),document.removeEventListener("keydown",this.#o)}#o;coordToLocal(t){const i=$t(xt(t,this.v_loc),this.#a);return Mt(xt(i,this.offset),this.scale)}handleSlotchange({target:t}){this.#e&&this.#s.unobserve(this.#e),this.#e=t.assignedElements().find((t=>t.matches("svg"))),this.#n(),this.#e&&this.#s.observe(this.#e)}#n(){const t=[this.#e.width.baseVal.value,this.#e.height.baseVal.value],i=this.surface.getBoundingClientRect();this.scale=Math.max(.2,Math.min(1,..._t(Ct([i.width,i.height],t),.95)))}#r;#h;#l;#c;static get styles(){return n`#touch-surface{position:relative;width:100%;height:100%;overflow:clip}::slotted(svg){transform-origin:0 0;position:absolute}.bottombar{position:fixed;bottom:0;height:var(--thickness);transform-origin:0 0;backface-visibility:hidden;will-change:width}.rightbar{position:fixed;width:var(--thickness);transform-origin:0 0;backface-visibility:hidden;right:0;will-change:height}*,::slotted(svg){transition-property:all}#bg{position:absolute;z-index:-1;height:100%;width:100%}`}};t([nt({type:Number})],Ot.prototype,"scale",void 0),t([rt()],Ot.prototype,"c_dim",void 0),t([rt()],Ot.prototype,"v_dim",void 0),t([rt()],Ot.prototype,"v_loc",void 0),t([rt()],Ot.prototype,"_scrollPos",void 0),t([at("#touch-surface",!0)],Ot.prototype,"surface",void 0),t([rt()],Ot.prototype,"smooth",void 0),t([lt({passive:!1,capture:!0})],Ot.prototype,"_wheel",null),t([lt({capture:!0})],Ot.prototype,"_gesturestart",null),t([lt({passive:!1})],Ot.prototype,"_gesturechange",null),Ot=t([et("bg-viewport")],Ot);const Nt=()=>{document.documentElement.style.setProperty("--app-height",`${window.innerHeight}px`)};window.addEventListener("resize",Nt),Nt();
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const{H:Pt}=F,jt=()=>document.createComment(""),Lt=(t,i,s)=>{var e;const o=t._$AA.parentNode,n=void 0===i?t._$AB:i._$AA;if(void 0===s){const i=o.insertBefore(jt(),n),e=o.insertBefore(jt(),n);s=new Pt(i,e,t,t.options)}else{const i=s._$AB.nextSibling,r=s._$AM,h=r!==t;if(h){let i;null===(e=s._$AQ)||void 0===e||e.call(s,t),s._$AM=t,void 0!==s._$AP&&(i=t._$AU)!==r._$AU&&s._$AP(i)}if(i!==n||h){let t=s._$AA;for(;t!==i;){const i=t.nextSibling;o.insertBefore(t,n),t=i}}}return s},Dt=(t,i,s=t)=>(t._$AI(i,s),t),It={},Bt=t=>{var i;null===(i=t._$AP)||void 0===i||i.call(t,!1,!0);let s=t._$AA;const e=t._$AB.nextSibling;for(;s!==e;){const t=s.nextSibling;s.remove(),s=t}},Jt=(t,i,s)=>{const e=new Map;for(let o=i;o<=s;o++)e.set(t[o],o);return e},Ht=vt(class extends pt{constructor(t){if(super(t),t.type!==ut)throw Error("repeat() can only be used in text expressions")}dt(t,i,s){let e;void 0===s?s=i:void 0!==i&&(e=i);const o=[],n=[];let r=0;for(const i of t)o[r]=e?e(i,r):r,n[r]=s(i,r),r++;return{values:n,keys:o}}render(t,i,s){return this.dt(t,i,s).values}update(t,[i,s,e]){var o;const n=(t=>t._$AH)(t),{values:r,keys:h}=this.dt(i,s,e);if(!Array.isArray(n))return this.at=h,r;const l=null!==(o=this.at)&&void 0!==o?o:this.at=[],a=[];let c,d,u=0,v=n.length-1,p=0,g=r.length-1;for(;u<=v&&p<=g;)if(null===n[u])u++;else if(null===n[v])v--;else if(l[u]===h[p])a[p]=Dt(n[u],r[p]),u++,p++;else if(l[v]===h[g])a[g]=Dt(n[v],r[g]),v--,g--;else if(l[u]===h[g])a[g]=Dt(n[u],r[g]),Lt(t,a[g+1],n[u]),u++,g--;else if(l[v]===h[p])a[p]=Dt(n[v],r[p]),Lt(t,n[u],n[v]),v--,p++;else if(void 0===c&&(c=Jt(h,p,g),d=Jt(l,u,v)),c.has(l[u]))if(c.has(l[v])){const i=d.get(h[p]),s=void 0!==i?n[i]:null;if(null===s){const i=Lt(t,n[u]);Dt(i,r[p]),a[p]=i}else a[p]=Dt(s,r[p]),Lt(t,n[u],s),n[i]=null;p++}else Bt(n[v]),v--;else Bt(n[u]),u++;for(;p<=g;){const i=Lt(t,a[g+1]);Dt(i,r[p]),a[p++]=i}for(;u<=v;){const t=n[u++];null!==t&&Bt(t)}return this.at=h,((t,i=It)=>{t._$AH=i})(t,a),P}}),Wt=async t=>{let i=t.dataTransfer?.items??[];return new Promise((async(t,s)=>{console.log("DataItems",i.length);for(let s=0;s<i.length;s++){if(console.log(i[s].type),i[s].type.startsWith("image/"))return t(i[s].getAsFile());if("text/html"===i[s].type)return void i[s].getAsString((i=>t(Zt(i))));if("application/x-moz-file-promise-url"===i[s].type)return void i[s].getAsString((t=>{}));if("string"===i[s].kind){let t=i[s].type;i[s].getAsString((i=>console.log(t,i)))}}return s("No compatible drop type found")}))};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Zt(t){const i=(new DOMParser).parseFromString(t,"text/html").querySelector("img")?.src;return i??null}const Gt=()=>([1e7]+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,(t=>(t^crypto.getRandomValues(new Uint8Array(1))[0]&15>>t/4).toString(16))),Kt=t=>new CustomEvent("game-event",{detail:t});class Vt{constructor(){this.order=[],this.map=new Map}get(t){const i=this.map.get(t);if(void 0!==i)return this.order[i]}has(t){return this.map.has(t)}add(t,i){this.map.set(t,this.order.length),this.order.push(i)}delete(t){const i=this.map.get(t);return void 0!==i&&(this.order.splice(i,1),this.map.delete(t),this.map.forEach(((t,s)=>{t>=i&&this.map.set(s,t-1)})),!0)}index(t){return this.map.get(t)}set_index(t,i){const s=this.map.get(t);if(void 0===s||i>=this.order.length)return!1;const e=this.order.splice(s,1)[0];return this.order.splice(i,0,e),this.map.forEach(((t,s)=>{t>=i&&this.map.set(s,t+1)})),this.map.set(t,i),!0}values(){return this.order}get size(){return this.map.size}}let Yt=class extends it{constructor(){super(),this.width=30,this.height=40,this.tokens=new Vt,this.selection=new Set,this.callouts=new Set,this.#g=0,this.#f=t=>{mt(t),this.#g++},this.#w=t=>{mt(t);const i=this.#b(t).map(Ft),s=_t(kt([this.width,this.height],-1),72);this._drop_hint=Ut([0,0],s,i),this.hovering="canvas"},this.#m=t=>{--this.#g<=0&&(this._drop_hint=void 0,this.hovering=void 0)},this.#y=t=>{mt(t),this._drop_hint=void 0,this.hovering="bg"},this.#$=async t=>{mt(t);try{const i=await Wt(t);this.dispatchEvent(yt("bg-drop",i))}catch(t){}this.#g=0,this.hovering=void 0},this.#k=async t=>{mt(t);try{const i=await Wt(t);this.dispatchEvent(yt("token-drop",{loc:this._drop_hint,dim:[72,72],img:i}))}catch(t){}this._drop_hint=void 0,this.hovering=void 0},this.#x=t=>{if(!wt(t))return;t.preventDefault(),t.stopPropagation();const i=t.target.id;t.shiftKey||t.ctrlKey?this.dispatchEvent(yt("token-select",[i,...this.selection].filter((t=>t!==i||!this.selection.has(i))))):this.dispatchEvent(yt("token-select",[t.target.id]))},this.#_=t=>{ft(t)&&(mt(t),t.target.setPointerCapture(t.pointerId),this.#S=this.#b(t))},this.#C=t=>{if(mt(t),!t.shiftKey&&!t.ctrlKey)return;let i,s=-1;const e=this.#b(t);for(const t of this.tokens.values()){const o=this.tokens.get(t.id),n=this.tokens.index(t.id)??-1;n>s&&At(e,o.loc)&&Tt(xt(e,o.loc),o.dim)&&(s=n,i=t.id)}i&&this.dispatchEvent(yt("token-select",[...this.selection].filter((t=>t!==i||!this.selection.has(i)))))},this.#M={move:[0,0],resize:[0,0],r:0},this.#A=t=>{if(!ft(t))return;this.#S||this.#_(t),mt(t);const i=Ut([0,0],this.#T,this.#b(t)),s=this.tokens.get(this.selection.values().next().value),e=s.dim,o=s.loc,n=t.target.classList;let r=[0,0],h=[0,0],l=0;if(n.contains("rn")&&(h[1]=o[1]-qt(i[1]),r[1]=qt(i[1])-o[1]),n.contains("rw")&&(h[0]=o[0]-qt(i[0]),r[0]=qt(i[0])-o[0]),n.contains("rs")&&(h[1]=qt(i[1])-e[1]-o[1]),n.contains("re")&&(h[0]=qt(i[0])-e[0]-o[0]),n.contains("ro")){const t=$t(o,Mt(e,2)),n=xt(i,t),r=180*Math.atan2(n[0],-n[1])/Math.PI;l=90*Math.round(r/90)-s.r%360}n.contains("selection-box")?r=xt(i,this.#S).map(qt):(r=Rt(kt(e,-72),r),h=Et(kt(_t(e,-1),72),h)),l===this.#M.r&&zt(r,this.#M.move)&&zt(h,this.#M.resize)||(this.#S=$t(this.#S,r),this.#M={move:[0,0],resize:[0,0],r:0},this.dispatchEvent(Kt({type:"token-manipulated",tokens:Array.from(this.selection,(t=>{let i=this.tokens.get(t);return{id:i.id,loc:$t(i.loc,r),dim:$t(i.dim,h),r:i.r+l}}))})))},this.#E=t=>{mt(t),this.#S=void 0},this.#b=t=>xt(this.viewport.coordToLocal([t.clientX,t.clientY]),[60,60]),this.#o=t=>{if(!this.selection)return;if(8===t.keyCode)return this.dispatchEvent(Kt({type:"token-removed",ids:Array.from(this.selection)})),void mt(t);"z"===t.key&&this.#R&&this.dispatchEvent(Kt({type:"callout",loc:this.#b(this.#R)})),this.tokens.get(this.selection.values().next().value);let i={ArrowUp:[0,-72],ArrowDown:[0,72],ArrowLeft:[-72,0],ArrowRight:[72,0]}[t.key];i&&(this.dispatchEvent(Kt({type:"token-manipulated",tokens:Array.from(this.selection,(t=>{const s=this.tokens.get(t),e=Ut([0,0],xt(this.#T,s.dim),$t(s.loc,i));return{id:s.id,loc:e,dim:s.dim,r:s.r}}))})),mt(t))}}#U;#R;get#T(){return _t([this.width,this.height],72)}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.#o)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this.#o)}render(){let[t,i]=this.#T,s=this.#z(),e=1===this.selection.size?this.tokens.get(this.selection.values().next().value):void 0;return O`
      <bg-viewport
        @pointerdown=${this.#O}
        @pointermove=${this.#N}
        @pointerup=${this.#P}
        @pointerleave=${()=>this.#R=void 0}
        @dragstart=${mt}
        @dragenter=${this.#f}
        @dragleave=${this.#m}
        @dragstop=${this.#m}
        ...
        <svg id="root" width=${t+120} height=${i+120}>
          ...
          <svg x=${60} y=${60} width=${t} height=${i} id="surface">
            ...
            <svg clip-path="url(#canvasClip)">
              ...
              <svg id="tokens">
                ${Ht(this.tokens.values(),(t=>t.id),((t,i)=>{const s=this.resources?.get(t.res),[e,o]=kt(t.dim,-1.5),[n,r]=kt(t.loc,.75);return O`
                      <svg
                        viewBox="0 0 1 1"
                        x=${n}
                        y=${r}
          ...
          `:null}
            ...
            ${this.#U?N`
              <rect id="sbox"
                x=${Math.min(this.#U.pin[0],this.#U.mouse[0])}
                y=${Math.min(this.#U.pin[1],this.#U.mouse[1])}
                width=${Math.abs(this.#U.pin[0]-this.#U.mouse[0])}
                height=${Math.abs(this.#U.pin[1]-this.#U.mouse[1])}
                ></rect>
              `:null}
            ${Ht(this.callouts,(t=>t),(t=>{const[i,s]=xt(t,[36,36]);return N`
                  <image href="assets/callout.svg" x=${i} y=${s} width=${72} height=${72}></image>
                `}))}
            ${s?N`
            <svg
              id="selection"
    ...
    `}createRenderRoot(){return super.createRenderRoot()}#g;#f;#w;#m;#y;#$;#k;#x;#O(t){if(!wt(t))return;t.target.setPointerCapture(t.pointerId);const i=this.#b(t);this.#U={pin:i,mouse:i}}#N(t){this.#R={clientX:t.clientX,clientY:t.clientY},this.#U&&(this.#U.mouse=this.#b(t),this.requestUpdate())}#P(t){if(!this.#U)return;t.target.setPointerCapture(t.pointerId);const i=Rt(this.#U.pin,this.#U.mouse),s=(t=>[Math.abs(t[0]),Math.abs(t[1])])(xt(this.#U.pin,this.#U.mouse)),e={start:i,end:$t(i,s)};console.log("box",e);const o=this.tokens.order.filter((t=>((t,i)=>!(i.start[0]>t.end[0]||i.end[0]<t.start[0]||i.start[1]>t.end[1]||i.end[1]<t.start[1]))(e,{start:t.loc,end:$t(t.loc,t.dim)}))).map((t=>t.id));console.log(o),this.#U=void 0,this.dispatchEvent(yt("token-select",o)),this.requestUpdate()}#z(){if(0===this.selection.size)return;const t=Array.from(this.selection,(t=>this.tokens.get(t))).filter((t=>t));let i=t[0].loc,s=$t(t[0].loc,t[0].dim);return t.forEach((t=>{i=Rt(i,t.loc),s=Et(s,$t(t.loc,t.dim))})),{start:i,end:s}}#S;#_;#C;#M;#A;#E;#b;#o};Yt.styles=n`
    :host {
      position: relative;
      display: block;
  ...
  `,t([nt({type:Number})],Yt.prototype,"width",void 0),t([nt({type:Number})],Yt.prototype,"height",void 0),t([nt()],Yt.prototype,"bg",void 0),t([nt({attribute:!1})],Yt.prototype,"tokens",void 0),t([nt({attribute:!1})],Yt.prototype,"resources",void 0),t([nt({attribute:!1})],Yt.prototype,"selection",void 0),t([nt({attribute:!1})],Yt.prototype,"callouts",void 0),t([nt({attribute:!1})],Yt.prototype,"sel_bbox",void 0),t([at("root",!0)],Yt.prototype,"root",void 0),t([at("bg-viewport",!0)],Yt.prototype,"viewport",void 0),t([rt()],Yt.prototype,"_drop_hint",void 0),t([rt()],Yt.prototype,"hovering",void 0),Yt=t([et("bg-canvas")],Yt);const qt=t=>72*Math.round(t/72),Ft=t=>t-t%72,Qt={iceServers:[{urls:"stun:stun.l.google.com:19302"}]};class Xt{constructor(t){this.#j=()=>{},this.#L=new RTCPeerConnection(Qt),this.#D=!1,this.#j=t,this.#I()}#j;#L;#D;async initiate(){this.#D=!0;let t=await this.#L.createOffer();await this.#L.setLocalDescription(t),this.#j({type:"offer",offer:t})}#I(){null!==this.#L.localDescription&&(this.#L.onicecandidate=null,this.#L.onconnectionstatechange=null,this.#L.close()),this.#L=new RTCPeerConnection(Qt),this.data=this.#L.createDataChannel("data",{ordered:!0,negotiated:!0,id:1}),this.events=this.#L.createDataChannel("control",{ordered:!0,negotiated:!0,id:2}),this.#L.onicecandidate=({candidate:t})=>{null!==t&&this.#j({type:"icecandidate",candidate:t})},this.#L.onconnectionstatechange=()=>{"closed"===this.#L.connectionState&&(this.#I(),this.#D&&this.initiate())}}async signal(t){console.log("received",t);let i=this.#L.signalingState;switch(t.type){case"offer":if("stable"!==i)return void console.error(`Received offer at incorrect state: ${i}. Ignoring.`);this.#L.setRemoteDescription(new RTCSessionDescription(t.offer));const s=await this.#L.createAnswer();await this.#L.setLocalDescription(s),this.#j({type:"answer",answer:s});break;case"answer":if("have-local-offer"!==i)return void console.error(`Received answer at incorrect state: ${i}. Ignoring.`);this.#L.setRemoteDescription(new RTCSessionDescription(t.answer));break;case"icecandidate":await this.#L.addIceCandidate(t.candidate)}}}class ti extends EventTarget{constructor(t,i){super(),this.#B=!1,this.#J="connected",this.#H=new Map,this.#W=t,this.#Z=i}#W;#Z;#B;#J;#H;get ident(){return this.#W}get status(){return this.#J}static async establish(t,i){i&&(t.pathname="/"+i);let s=await this.#G(t);return console.log("acquired socket for ",i),new Promise(((t,i)=>{s.addEventListener("message",(e=>{let o=JSON.parse(e.data);s.removeEventListener("close",i);let n=new ti(o.id,s);n.#K(),t(n)}),{once:!0}),s.addEventListener("close",i)}))}static async#G(t){return new Promise(((i,s)=>{let e=new WebSocket(t.toString());e.addEventListener("close",(t=>s(t)),{once:!0}),e.addEventListener("open",(()=>{console.log("WS CONNECTED"),e.removeEventListener("close",s),i(e)}))}))}#K(){let t=new URL(this.#Z.url);this.#Z.addEventListener("error",(t=>{this.dispatchEvent(new CustomEvent("error",{detail:t}))})),this.#Z.addEventListener("close",(()=>this.#V(t))),this.#Z.addEventListener("message",(t=>{let i=JSON.parse(t.data);this.#Y(i)}))}async connect_to(t){let i=new Xt((i=>{this.#Z.send(JSON.stringify({target:t,...i})),"shutdown"===i.type&&this.#H.delete(i.from)}));return this.#H.set(t,i),await i.initiate(),i}#q(t){this.#J=t,this.dispatchEvent(new CustomEvent("status",{detail:t}))}async#V(t){let i;if(t.pathname="/"+this.#W,this.#B)this.#q("closed");else{this.#q("disconnected");try{i=await ti.#G(t)}catch(t){return console.error("Error reconnecting",t),void setTimeout((()=>this.#V),1e3)}this.#Z=i,this.#K(),this.#q("connected")}}_disconnect(){this.#Z.close()}close(){this.#B=!0,this.#Z.close()}#Y(t){if(console.log(t),t.error)this.dispatchEvent(new CustomEvent("error",{detail:t.error}));else if("offer"!==t.type||this.#H.has(t.from))this.#H.get(t.from)?.signal(t),"shutdown"===t.type&&this.#H.delete(t.from);else{let i=new Xt((i=>{this.#Z.send(JSON.stringify({target:t.from,...i})),"shutdown"===t.type&&this.#H.delete(t.from)}));this.#H.set(t.from,i),i.signal(t),this.dispatchEvent(new CustomEvent("peer",{detail:i}))}}}const ii=t=>{let i=(t=>new ReadableStream({start(i){t.onmessage=({data:t})=>i.enqueue(t);const s=()=>{i.close(),t.removeEventListener("close",s)};t.addEventListener("close",s)},cancel(){t.close()}}))(t).pipeThrough((()=>{let t,i=[];return new TransformStream({start(){},async transform(s,e){if("string"==typeof s){let i=JSON.parse(s);if("event"===i.type)return void e.enqueue(i.event);t=i}else{if(!t)return;if(i.push(s),0==--t.chunks)return e.enqueue({type:"file",res_name:t.res_name,contents:new Blob(i)}),void(i=[])}},flush(){i=[]}})})()),s=new TransformStream({start(){},async transform(t,i){if("file"===t.type){i.enqueue(JSON.stringify({type:"file",res_name:t.res_name,chunks:Math.ceil(t.contents.size/64e3)}));for(let s=0;s<t.contents.size;s+=64e3)i.enqueue(await t.contents.slice(s,Math.min(s+64e3,t.contents.size)).arrayBuffer())}else i.enqueue(JSON.stringify({type:"event",event:t}))}});return s.readable.pipeTo((t=>{let i;return new WritableStream({start(s){const e=()=>{s.error("Closed"),t.removeEventListener("close",e)};t.addEventListener("close",e),t.onopen=()=>i&&i(),t.onbufferedamountlow=()=>i&&i()},async write(s){("connecting"===t.readyState||t.bufferedAmount>t.bufferedAmountLowThreshold)&&await new Promise(((t,s)=>i=t)),t.send(s)},abort(){t.close()}},new CountQueuingStrategy({highWaterMark:1}))})(t)),{writable:s.writable,readable:i}};class si{constructor(t){this.server=this,this.#F=new Set,this.#Q=new Set,this.on_event=()=>{},this.signaler=t;let{readable:i,writable:s}=new TransformStream({start(){},transform(t,i){console.log("TF STREAM"),i.enqueue(t)},flush(){}}),e=i.getReader(),o=s.getWriter();this.signaler.addEventListener("peer",(async({detail:t})=>{let i=ii(t.events),s=ii(t.data);const e=i.writable.getWriter(),n=s.writable.getWriter();this.#F.add(e),this.#Q.add(n),console.log("Getting state"),this.get_state&&(console.log("state",this.get_state()),e.write(this.get_state())),console.log("writing images");for(const[t,i]of this.get_images?this.get_images():[])console.log(t,i),n.write({type:"file",res_name:t,contents:await(await fetch(i)).blob()});(async()=>{let t,s,n=i.readable.getReader();for(;({value:t,done:s}=await n.read())&&!s;)await o.write({author:e,ev:t});this.#F.delete(e)})(),(async()=>{let t,i,r=s.readable.getReader();for(;({value:t,done:i}=await r.read())&&!i;)await o.write({author:e,ev:t});this.#Q.delete(n)})()})),(async()=>{let t,i,s;for(;({value:{author:s,ev:t},done:i}=await e.read())&&!i;)await this.send_event(t,s),this.on_event(t)})()}get status(){return"connected"===this.signaler.status?"connected":"disconnected"}#F;#Q;async send_event(t,i){let s="file"===t.type?this.#Q:this.#F;await Promise.all(Array.from(s).filter((t=>t!==i)).map((i=>i.write(t))))}static async establish(){return new si(await ti.establish(new URL("wss://battlegrid-signaling.herokuapp.com/")))}}class ei{constructor(t){this.status="disconnected",this.server=void 0,this.on_event=t=>{},this.on_status=()=>{},this.#X=t}#tt;#it;#X;#q(t){this.status=t,setTimeout(this.on_status,0)}async connect(){let t;this.#q("connecting");try{let i=await ti.establish(new URL("wss://battlegrid-signaling.herokuapp.com"));t=await new Promise((async(t,s)=>{i.addEventListener("error",s,{once:!0});let e=await i.connect_to(this.#X);e.data.onopen=()=>t(e)}))}catch(t){return console.log("error"),void this.#q("error")}let i=ii(t.events);this.#tt=i.writable.getWriter();let s=i.readable.getReader(),e=ii(t.data);this.#it=e.writable.getWriter();let o=e.readable.getReader();this.#q("connected"),(async()=>{let t,i;for(;({value:t,done:i}=await o.read())&&!i;)console.log("DATA",t),this.on_event(t);console.log("dccccc"),this.#q("disconnected")})(),(async()=>{let t,i;for(;({value:t,done:i}=await s.read())&&!i;)console.log("EVENT!",t),this.on_event(t);console.log("dccccc"),this.#q("disconnected")})()}async send_event(t){("file"===t.type?this.#it:this.#tt)?.write(t)}}let oi=class extends it{constructor(){super(...arguments),this._state=!1,this._loaded=!1,this._buy=t=>{console.log("CLICK"),mt(t),this._state=!0,document.addEventListener("click",this.#st,{capture:!0})},this.#st=t=>{mt(t),this._state=!1,document.removeEventListener("click",this.#st,{capture:!0})},this.#et=t=>{this._loaded=!0}}render(){return O`<button @click="${this._buy}">Buy Me A Coffee</button> ${this._state?O`<div id="container"><iframe class="${this._loaded?"loaded":""}" allow="payment" src="https://ko-fi.com/djrenren/?hidefeed=true&widget=true&embed=true&preview=true" title="djrenren" @load="${this.#et}"></iframe></div>`:null}`}#st;#et};oi.styles=n`:host{display:block;position:relative}iframe{border:none;display:block;opacity:0;width:100%;height:100%;transition:opacity .5s linear}#container{border-radius:5px;box-shadow:0 0 6px rgba(0,0,0,.7);position:absolute;width:350px;height:525px;bottom:-535px;right:0;animation-name:fade;animation-duration:.5s;animation-direction:backwards;background:url(assets/loading.svg) center/100px no-repeat,#ededf0;overflow:hidden}iframe.loaded{opacity:1}@keyframes fade{0%{opacity:0}100%{opacity:1}}`,t([rt()],oi.prototype,"_state",void 0),t([rt()],oi.prototype,"_loaded",void 0),oi=t([et("buy-me-a-coffee")],oi);class ni{constructor(){this.index=new Set}get(t){return t.startsWith("local:")?window.sessionStorage.getItem(t):t}delete(t){const i=this.get(t);return!!i&&(URL.revokeObjectURL(i),window.sessionStorage.removeItem(t),!0)}register(t,i){if("string"==typeof t)return t;let s=i??"local:"+Gt();return this.index.add(s),window.sessionStorage.setItem(s,URL.createObjectURL(t)),s}*all(){for(let t of this.index.values())yield[t,this.get(t)]}}class ri extends EventTarget{constructor(){super(...arguments),this.tokens=new Vt,this.grid_dim=[30,20],this.resources=new ni,this.callouts=new Set,this.get_state=()=>({type:"state-sync",tokens:[...this.tokens.values()],grid_dim:this.grid_dim,bg:this.#ot})}#ot;get bg(){return this.#ot?this.resources.get(this.#ot):null}set_bg(t){const i=t?this.resources.register(t):void 0;this.apply({type:"bg",res:i}),t instanceof Blob&&this.dispatchEvent(Kt({type:"file",res_name:i,contents:t}))}add_token(t,i){const s=Gt(),e=this.resources.register(t),o={id:s,res:e,...i};this.apply({type:"token-added",...o}),t instanceof Blob&&this.dispatchEvent(Kt({type:"file",res_name:e,contents:t}))}local_apply(t){switch(console.log("APPLYING!"),t.type){case"token-manipulated":for(let i of t.tokens){let t=this.tokens.get(i.id);if(!t)return void console.error("Update received for nonexistant token",i.id);Object.assign(t,{dim:i.dim,loc:i.loc,r:i.r})}break;case"token-added":let i={id:t.id,dim:t.dim,loc:t.loc,res:t.res,r:0};this.tokens.add(t.id,i);break;case"grid-resized":this.grid_dim=t.dim;break;case"token-removed":for(let i of t.ids){const t=this.tokens.get(i);if(!t)return void console.error("Tried to remove nonexistant token",i);this.resources.delete(t.res),this.tokens.delete(t.id)}break;case"state-sync":console.log("applying #tokens",t.tokens),this.tokens=new Vt;for(const i of t.tokens)this.tokens.add(i.id,i);this.grid_dim=t.grid_dim,this.#ot=t.bg;break;case"token-reorder":const s=this.tokens.index(t.id);if(void 0===s)return void console.error("Tried to reorder non-existant token",t.id);let e;e="top"===t.idx?this.tokens.size-1:"bottom"===t.idx?0:"up"===t.idx?Math.min(this.tokens.size-1,s+1):Math.max(0,s-1),this.tokens.set_index(t.id,e);break;case"file":this.resources.register(t.contents,t.res_name);break;case"bg":this.#ot&&this.resources.delete(this.#ot),this.#ot=t.res;break;case"callout":this.callouts?.add(t.loc),setTimeout((()=>{this.callouts.delete(t.loc),this.dispatchEvent(new CustomEvent("updated"))}),1500)}this.dispatchEvent(new CustomEvent("updated"))}remove_token(t){this.apply({type:"token-removed",ids:[t]})}apply(t){this.local_apply(t),this.dispatchEvent(new CustomEvent("game-event",{detail:t}))}set_dim(t){this.apply({type:"grid-resized",dim:t})}}
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const hi=t=>t[Symbol.iterator]().next().value;let li=class extends it{constructor(){super(...arguments),this.selection=new Set,this.host_pending=!1,this.#nt=new ri,this.#rt=()=>{this.#nt.set_dim(Et([1,1],[parseInt(this.width?.value)??0,parseInt(this.height?.value)??0]))},this.#ht=()=>{this.client&&!this.client.server&&this.client.connect()},this.#lt=()=>{this.client=void 0,window.history.pushState(null,"",window.location.href.split("?")[0])},this.#at=async()=>{try{this.host_pending=!0;let t=await si.establish();this.host_pending=!1,this.client=t,t.on_event=this.#ct,t.get_state=this.#nt.get_state,t.get_images=()=>this.#nt.resources.all(),window.history.pushState({},"","?game="+t.signaler.ident),navigator.clipboard.writeText(window.location.toString())}catch(t){console.error(t)}},this.#ct=t=>{this.#nt.local_apply(t)},this.#dt=t=>{this.client?.send_event(t.detail)}}#nt;render(){let t="error"===this.client?.status?O`<div class="message error"><div><h1>Error connecting to remote grid</h1><button @click="${this.#ht}">Try again</button> <button @click="${this.#lt}">New local grid</button></div></div>`:null,i="connecting"===this.client?.status?O`<div class="message"><div><h1>Connecting to grid...</h1></div></div>`:null,s="disconnected"===this.client?.status?O`<div class="message"><div><h1>Disconnected from host</h1><button @click="${this.#ht}">Try again</button> <button @click="${this.#lt}">Continue locally</button></div></div>`:null,e=t||i||s;return O`<section id="toolbar" class="group"><div class="group"><span>Grid: <input id="width" type="number" min="1" @input="${this.#rt}" .value="${this.#nt.grid_dim[0]+""}"> x <input id="height" type="number" min="1" @input="${this.#rt}" .value="${this.#nt.grid_dim[1]+""}"> </span>${1===this.selection.size?O`<div><button @click="${()=>this.#nt.apply({type:"token-reorder",id:hi(this.selection),idx:"down"})}" ?disabled="${0===this.#nt.tokens.index(hi(this.selection))}">Move Down</button> <button @click="${()=>this.#nt.apply({type:"token-reorder",id:hi(this.selection),idx:"up"})}" ?disabled="${this.#nt.tokens.index(hi(this.selection))===this.#nt.tokens.size-1}">Move Up</button></div>`:null}</div><div class="group">${this.host_pending?O`<img src="assets/loading.svg">`:this.client?O`<div>${this.client.server?"hosting":this.client.status}</div>`:O`<button @click="${this.#at}">Host</button>`}<buy-me-a-coffee class="right"></buy-me-a-coffee></div></section><bg-canvas bg="${(t=>null!=t?t:j)(this.#nt.bg??void 0)}" .selection="${this.selection}" width="${this.#nt.grid_dim[0]}" height="${this.#nt.grid_dim[1]}" .tokens="${this.#nt.tokens}" .resources="${this.#nt.resources}" .callouts="${this.#nt.callouts}" @token-drop="${({detail:t})=>this.#nt.add_token(t.img,{loc:t.loc,r:0,dim:t.dim})}" @bg-drop="${({detail:t})=>this.#nt.set_bg(t)}" @token-select="${({detail:t})=>{this.selection=new Set(t)}}" @game-event="${({detail:t})=>this.#nt.apply(t)}"></bg-canvas>${e}`}updated(t){t.has("client")&&(document.title="BattleGrid"+(this.client&&"connected"===this.client.status?this.client.server?"- Hosting":"- Connected":""))}#rt;async connectedCallback(){super.connectedCallback(),this.#nt.addEventListener("game-event",this.#dt),this.#nt.addEventListener("updated",(()=>{for(const t of this.selection)this.#nt.tokens.has(t)||this.selection.delete(t);this.requestUpdate(),this.canvas?.requestUpdate()}));let t=new URLSearchParams(window.location.search).get("game");if(!t)return{};let i=new ei(t);i.on_event=this.#ct,i.on_status=()=>this.requestUpdate("client"),this.client=i,await i.connect()}#ht;#lt;#at;#ct;#dt};li.styles=n`:host{width:100%;height:100%;display:grid;grid:"toolbar" 30px "viewport" 1fr/1fr;font-family:inherit;--ui-bg:#f9f9fa}.message{grid-area:1/1/3/1;display:grid;align-items:center;justify-items:center;background:#fff;z-index:2}.right{justify-self:end}bg-canvas{grid-area:viewport;z-index:1}input[type=number]{width:3em}.group{display:flex;align-items:center;height:100%;flex-wrap:nowrap}#toolbar{grid-area:toolbar;box-shadow:0 0 4px gray;z-index:2;background:var(--ui-bg);justify-content:space-between;padding:0 1em;grid-template-rows:unset}.group img{width:1em;height:1em;object-fit:cover;display:inline-block}`,t([at("#width",!0)],li.prototype,"width",void 0),t([at("#height",!0)],li.prototype,"height",void 0),t([at("bg-canvas",!0)],li.prototype,"canvas",void 0),t([rt()],li.prototype,"client",void 0),t([rt()],li.prototype,"selection",void 0),t([rt()],li.prototype,"host_pending",void 0),li=t([et("bg-app")],li),document.body.addEventListener("wheel",(t=>{console.log("HUH..."),t.ctrlKey&&t.preventDefault()}),{passive:!1});
