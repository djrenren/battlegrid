 ...
 */function Ht(t){const i=(new DOMParser).parseFromString(t,"text/html").querySelector("img")?.src;return i??null}const Wt=()=>([1e7]+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,(t=>(t^crypto.getRandomValues(new Uint8Array(1))[0]&15>>t/4).toString(16))),Zt=t=>new CustomEvent("game-event",{detail:t});class Gt{constructor(){this.order=[],this.map=new Map}get(t){const i=this.map.get(t);if(void 0!==i)return this.order[i]}has(t){return this.map.has(t)}add(t,i){this.map.set(t,this.order.length),this.order.push(i)}delete(t){const i=this.map.get(t);return void 0!==i&&(this.order.splice(i,1),this.map.delete(t),this.map.forEach(((t,s)=>{t>=i&&this.map.set(s,t-1)})),!0)}index(t){return this.map.get(t)}set_index(t,i){const s=this.map.get(t);if(void 0===s||i>=this.order.length)return!1;const e=this.order.splice(s,1)[0];return this.order.splice(i,0,e),this.map.forEach(((t,s)=>{t>=i&&this.map.set(s,t+1)})),this.map.set(t,i),!0}values(){return this.order}get size(){return this.map.size}}let Kt=class extends it{constructor(){super(),this.width=30,this.height=40,this.tokens=new Gt,this.selection=[],this.#g=0,this.#f=t=>{mt(t),this.#g++},this.#w=t=>{mt(t);const i=this.#b(t).map(qt),s=_t(kt([this.width,this.height],-1),72);this._drop_hint=Et([0,0],s,i),this.hovering="canvas"},this.#m=t=>{--this.#g<=0&&(this._drop_hint=void 0,this.hovering=void 0)},this.#y=t=>{mt(t),this._drop_hint=void 0,this.hovering="bg"},this.#$=async t=>{mt(t);try{const i=await Jt(t);this.dispatchEvent(yt("bg-drop",i))}catch(t){}this.hovering=void 0},this.#k=async t=>{mt(t);try{const i=await Jt(t);this.dispatchEvent(yt("token-drop",{loc:this._drop_hint,dim:[72,72],img:i}))}catch(t){}this._drop_hint=void 0,this.hovering=void 0},this.#x=t=>{wt(t)&&(t.preventDefault(),t.stopPropagation(),this.dispatchEvent(yt("token-select",[t.target.id])))},this.#_=t=>{ft(t)&&(mt(t),t.target.setPointerCapture(t.pointerId),this.#S=this.#b(t))},this.#C={move:[0,0],resize:[0,0],r:0},this.#M=t=>{if(!ft(t))return;this.#S||this.#_(t),mt(t);const i=Et([0,0],this.#A,this.#b(t)),s=this.tokens.get(this.selection[0]),e=s.dim,o=s.loc,n=t.target.classList;let r=[0,0],h=[0,0],l=0;if(n.contains("rn")&&(h[1]=o[1]-Vt(i[1]),r[1]=Vt(i[1])-o[1]),n.contains("rw")&&(h[0]=o[0]-Vt(i[0]),r[0]=Vt(i[0])-o[0]),n.contains("rs")&&(h[1]=Vt(i[1])-e[1]-o[1]),n.contains("re")&&(h[0]=Vt(i[0])-e[0]-o[0]),n.contains("ro")){const t=$t(o,Mt(e,2)),n=xt(i,t),r=180*Math.atan2(n[0],-n[1])/Math.PI;l=90*Math.round(r/90)-s.r%360}n.contains("selection-box")?r=xt(i,this.#S).map(Vt):(r=Tt(kt(e,-72),r),h=At(kt(_t(e,-1),72),h)),l===this.#C.r&&Rt(r,this.#C.move)&&Rt(h,this.#C.resize)||(this.#S=$t(this.#S,r),this.#C={move:[0,0],resize:[0,0],r:0},this.dispatchEvent(Zt({type:"token-manipulated",id:s.id,loc:$t(s.loc,r),dim:$t(s.dim,h),r:s.r+l})))},this.#T=t=>{mt(t),this.#S=void 0},this.#b=t=>xt(this.viewport.coordToLocal([t.clientX,t.clientY]),[60,60]),this.#o=t=>{if(!this.selection)return;if(8===t.keyCode)return this.dispatchEvent(Zt({type:"token-removed",id:this.selection[0]})),void mt(t);let i=this.tokens.get(this.selection[0]);let s={ArrowUp:[0,-72],ArrowDown:[0,72],ArrowLeft:[-72,0],ArrowRight:[72,0]}[t.key];s&&(i.loc=Et([0,0],xt(this.#A,i.dim),$t(i.loc,s)),this.dispatchEvent(Zt({type:"token-manipulated",id:i.id,loc:i.loc,dim:i.dim,r:i.r})),mt(t))}}#E;get#A(){return _t([this.width,this.height],72)}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.#o)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this.#o)}render(){let[t,i]=this.#A,s=1===this.selection.length?this.tokens.get(this.selection[0]):void 0;return O`
    ...
    `}createRenderRoot(){return super.createRenderRoot()}#g;#f;#w;#m;#y;#$;#k;#x;#R(t){if(!wt(t))return;t.target.setPointerCapture(t.pointerId);const i=this.#b(t);this.#E={pin:i,mouse:i}}#U(t){this.#E&&(this.#E.mouse=this.#b(t),this.requestUpdate())}#z(t){if(!this.#E)return;t.target.setPointerCapture(t.pointerId);const i=Tt(this.#E.pin,this.#E.mouse),s=(t=>[Math.abs(t[0]),Math.abs(t[1])])(xt(this.#E.pin,this.#E.mouse)),e={start:i,end:$t(i,s)};console.log("box",e);const o=this.tokens.order.filter((t=>((t,i)=>!(i.start[0]>t.end[0]||i.end[0]<t.start[0]||i.start[1]>t.end[1]||i.end[1]<t.start[1]))(e,{start:t.loc,end:$t(t.loc,t.dim)}))).map((t=>t.id));console.log(o),this.#E=void 0,this.dispatchEvent(yt("token-select",o)),this.requestUpdate()}#S;#_;#C;#M;#T;#b;#o};Kt.styles=n`
    :host {
      position: relative;
      display: block;
  ...
  `,t([nt({type:Number})],Kt.prototype,"width",void 0),t([nt({type:Number})],Kt.prototype,"height",void 0),t([nt()],Kt.prototype,"bg",void 0),t([nt({attribute:!1})],Kt.prototype,"tokens",void 0),t([nt({attribute:!1})],Kt.prototype,"resources",void 0),t([nt({attribute:!1})],Kt.prototype,"selection",void 0),t([at("root",!0)],Kt.prototype,"root",void 0),t([at("bg-viewport",!0)],Kt.prototype,"viewport",void 0),t([at("#tokens",!0)],Kt.prototype,"token_svg",void 0),t([at("#sbox")],Kt.prototype,"sbox_rect",void 0),t([rt()],Kt.prototype,"_drop_hint",void 0),t([rt()],Kt.prototype,"hovering",void 0),Kt=t([et("bg-canvas")],Kt);const Vt=t=>72*Math.round(t/72),qt=t=>t-t%72,Ft={iceServers:[{urls:"stun:stun.l.google.com:19302"}]};class Yt{constructor(t){this.#O=()=>{},this.#N=new RTCPeerConnection(Ft),this.#P=!1,this.#O=t,this.#j()}#O;#N;#P;async initiate(){this.#P=!0;let t=await this.#N.createOffer();await this.#N.setLocalDescription(t),this.#O({type:"offer",offer:t})}#j(){null!==this.#N.localDescription&&(this.#N.onicecandidate=null,this.#N.onconnectionstatechange=null,this.#N.close()),this.#N=new RTCPeerConnection(Ft),this.data=this.#N.createDataChannel("data",{ordered:!0,negotiated:!0,id:1}),this.events=this.#N.createDataChannel("control",{ordered:!0,negotiated:!0,id:2}),this.#N.onicecandidate=({candidate:t})=>{null!==t&&this.#O({type:"icecandidate",candidate:t})},this.#N.onconnectionstatechange=()=>{"closed"===this.#N.connectionState&&(this.#j(),this.#P&&this.initiate())}}async signal(t){console.log("received",t);let i=this.#N.signalingState;switch(t.type){case"offer":if("stable"!==i)return void console.error(`Received offer at incorrect state: ${i}. Ignoring.`);this.#N.setRemoteDescription(new RTCSessionDescription(t.offer));const s=await this.#N.createAnswer();await this.#N.setLocalDescription(s),this.#O({type:"answer",answer:s});break;case"answer":if("have-local-offer"!==i)return void console.error(`Received answer at incorrect state: ${i}. Ignoring.`);this.#N.setRemoteDescription(new RTCSessionDescription(t.answer));break;case"icecandidate":await this.#N.addIceCandidate(t.candidate)}}}class Qt extends EventTarget{constructor(t,i){super(),this.#L=!1,this.#D="connected",this.#I=new Map,this.#B=t,this.#J=i}#B;#J;#L;#D;#I;get ident(){return this.#B}get status(){return this.#D}static async establish(t,i){i&&(t.pathname="/"+i);let s=await this.#H(t);return console.log("acquired socket for ",i),new Promise(((t,i)=>{s.addEventListener("message",(e=>{let o=JSON.parse(e.data);s.removeEventListener("close",i);let n=new Qt(o.id,s);n.#W(),t(n)}),{once:!0}),s.addEventListener("close",i)}))}static async#H(t){return new Promise(((i,s)=>{let e=new WebSocket(t.toString());e.addEventListener("close",(t=>s(t)),{once:!0}),e.addEventListener("open",(()=>{console.log("WS CONNECTED"),e.removeEventListener("close",s),i(e)}))}))}#W(){let t=new URL(this.#J.url);this.#J.addEventListener("error",(t=>{this.dispatchEvent(new CustomEvent("error",{detail:t}))})),this.#J.addEventListener("close",(()=>this.#Z(t))),this.#J.addEventListener("message",(t=>{let i=JSON.parse(t.data);this.#G(i)}))}async connect_to(t){let i=new Yt((i=>{this.#J.send(JSON.stringify({target:t,...i})),"shutdown"===i.type&&this.#I.delete(i.from)}));return this.#I.set(t,i),await i.initiate(),i}#K(t){this.#D=t,this.dispatchEvent(new CustomEvent("status",{detail:t}))}async#Z(t){let i;if(t.pathname="/"+this.#B,this.#L)this.#K("closed");else{this.#K("disconnected");try{i=await Qt.#H(t)}catch(t){return console.error("Error reconnecting",t),void setTimeout((()=>this.#Z),1e3)}this.#J=i,this.#W(),this.#K("connected")}}_disconnect(){this.#J.close()}close(){this.#L=!0,this.#J.close()}#G(t){if(console.log(t),t.error)this.dispatchEvent(new CustomEvent("error",{detail:t.error}));else if("offer"!==t.type||this.#I.has(t.from))this.#I.get(t.from)?.signal(t),"shutdown"===t.type&&this.#I.delete(t.from);else{let i=new Yt((i=>{this.#J.send(JSON.stringify({target:t.from,...i})),"shutdown"===t.type&&this.#I.delete(t.from)}));this.#I.set(t.from,i),i.signal(t),this.dispatchEvent(new CustomEvent("peer",{detail:i}))}}}const Xt=t=>{let i=(t=>new ReadableStream({start(i){t.onmessage=({data:t})=>i.enqueue(t);const s=()=>{i.close(),t.removeEventListener("close",s)};t.addEventListener("close",s)},cancel(){t.close()}}))(t).pipeThrough((()=>{let t,i=[];return new TransformStream({start(){},async transform(s,e){if("string"==typeof s){let i=JSON.parse(s);if("event"===i.type)return void e.enqueue(i.event);t=i}else{if(!t)return;if(i.push(s),0==--t.chunks)return e.enqueue({type:"file",res_name:t.res_name,contents:new Blob(i)}),void(i=[])}},flush(){i=[]}})})()),s=new TransformStream({start(){},async transform(t,i){if("file"===t.type){i.enqueue(JSON.stringify({type:"file",res_name:t.res_name,chunks:Math.ceil(t.contents.size/64e3)}));for(let s=0;s<t.contents.size;s+=64e3)i.enqueue(await t.contents.slice(s,Math.min(s+64e3,t.contents.size)).arrayBuffer())}else i.enqueue(JSON.stringify({type:"event",event:t}))}});return s.readable.pipeTo((t=>{let i;return new WritableStream({start(s){const e=()=>{s.error("Closed"),t.removeEventListener("close",e)};t.addEventListener("close",e),t.onopen=()=>i&&i(),t.onbufferedamountlow=()=>i&&i()},async write(s){("connecting"===t.readyState||t.bufferedAmount>t.bufferedAmountLowThreshold)&&await new Promise(((t,s)=>i=t)),t.send(s)},abort(){t.close()}},new CountQueuingStrategy({highWaterMark:1}))})(t)),{writable:s.writable,readable:i}};class ti{constructor(t){this.server=this,this.#V=new Set,this.#q=new Set,this.on_event=()=>{},this.signaler=t;let{readable:i,writable:s}=new TransformStream({start(){},transform(t,i){console.log("TF STREAM"),i.enqueue(t)},flush(){}}),e=i.getReader(),o=s.getWriter();this.signaler.addEventListener("peer",(async({detail:t})=>{let i=Xt(t.events),s=Xt(t.data);const e=i.writable.getWriter(),n=s.writable.getWriter();this.#V.add(e),this.#q.add(n),console.log("Getting state"),this.get_state&&(console.log("state",this.get_state()),e.write(this.get_state())),console.log("writing images");for(const[t,i]of this.get_images?this.get_images():[])console.log(t,i),n.write({type:"file",res_name:t,contents:await(await fetch(i)).blob()});(async()=>{let t,s,n=i.readable.getReader();for(;({value:t,done:s}=await n.read())&&!s;)await o.write({author:e,ev:t});this.#V.delete(e)})(),(async()=>{let t,i,r=s.readable.getReader();for(;({value:t,done:i}=await r.read())&&!i;)await o.write({author:e,ev:t});this.#q.delete(n)})()})),(async()=>{let t,i,s;for(;({value:{author:s,ev:t},done:i}=await e.read())&&!i;)await this.send_event(t,s),this.on_event(t)})()}get status(){return"connected"===this.signaler.status?"connected":"disconnected"}#V;#q;async send_event(t,i){let s="file"===t.type?this.#q:this.#V;await Promise.all(Array.from(s).filter((t=>t!==i)).map((i=>i.write(t))))}static async establish(){return new ti(await Qt.establish(new URL("wss://battlegrid-signaling.herokuapp.com/")))}}class ii{constructor(t){this.status="disconnected",this.server=void 0,this.on_event=t=>{},this.on_status=()=>{},this.#F=t}#Y;#Q;#F;#K(t){this.status=t,setTimeout(this.on_status,0)}async connect(){let t;this.#K("connecting");try{let i=await Qt.establish(new URL("wss://battlegrid-signaling.herokuapp.com"));t=await new Promise((async(t,s)=>{i.addEventListener("error",s,{once:!0});let e=await i.connect_to(this.#F);e.data.onopen=()=>t(e)}))}catch(t){return console.log("error"),void this.#K("error")}let i=Xt(t.events);this.#Y=i.writable.getWriter();let s=i.readable.getReader(),e=Xt(t.data);this.#Q=e.writable.getWriter();let o=e.readable.getReader();this.#K("connected"),(async()=>{let t,i;for(;({value:t,done:i}=await o.read())&&!i;)console.log("DATA",t),this.on_event(t);console.log("dccccc"),this.#K("disconnected")})(),(async()=>{let t,i;for(;({value:t,done:i}=await s.read())&&!i;)console.log("EVENT!",t),this.on_event(t);console.log("dccccc"),this.#K("disconnected")})()}async send_event(t){("file"===t.type?this.#Q:this.#Y)?.write(t)}}let si=class extends it{constructor(){super(...arguments),this._state=!1,this._loaded=!1,this._buy=t=>{console.log("CLICK"),mt(t),this._state=!0,document.addEventListener("click",this.#X,{capture:!0})},this.#X=t=>{mt(t),this._state=!1,document.removeEventListener("click",this.#X,{capture:!0})},this.#tt=t=>{this._loaded=!0}}render(){return O`<button @click="${this._buy}">Buy Me A Coffee</button> ${this._state?O`<div id="container"><iframe class="${this._loaded?"loaded":""}" allow="payment" src="https://ko-fi.com/djrenren/?hidefeed=true&widget=true&embed=true&preview=true" title="djrenren" @load="${this.#tt}"></iframe></div>`:null}`}#X;#tt};si.styles=n`:host{display:block;position:relative}iframe{border:none;display:block;opacity:0;width:100%;height:100%;transition:opacity .5s linear}#container{border-radius:5px;box-shadow:0 0 6px rgba(0,0,0,.7);position:absolute;width:350px;height:525px;bottom:-535px;right:0;animation-name:fade;animation-duration:.5s;animation-direction:backwards;background:url(assets/loading.svg) center/100px no-repeat,#ededf0;overflow:hidden}iframe.loaded{opacity:1}@keyframes fade{0%{opacity:0}100%{opacity:1}}`,t([rt()],si.prototype,"_state",void 0),t([rt()],si.prototype,"_loaded",void 0),si=t([et("buy-me-a-coffee")],si);class ei{constructor(){this.index=new Set}get(t){return t.startsWith("local:")?window.sessionStorage.getItem(t):t}delete(t){const i=this.get(t);return!!i&&(URL.revokeObjectURL(i),window.sessionStorage.removeItem(t),!0)}register(t,i){if("string"==typeof t)return t;let s=i??"local:"+Wt();return this.index.add(s),window.sessionStorage.setItem(s,URL.createObjectURL(t)),s}*all(){for(let t of this.index.values())yield[t,this.get(t)]}}class oi extends EventTarget{constructor(){super(...arguments),this.tokens=new Gt,this.grid_dim=[30,20],this.resources=new ei,this.get_state=()=>({type:"state-sync",tokens:[...this.tokens.values()],grid_dim:this.grid_dim,bg:this.#it})}#it;get bg(){return this.#it?this.resources.get(this.#it):null}set_bg(t){const i=t?this.resources.register(t):void 0;this.apply({type:"bg",res:i}),t instanceof Blob&&this.dispatchEvent(Zt({type:"file",res_name:i,contents:t}))}add_token(t,i){const s=Wt(),e=this.resources.register(t),o={id:s,res:e,...i};this.apply({type:"token-added",...o}),t instanceof Blob&&this.dispatchEvent(Zt({type:"file",res_name:e,contents:t}))}local_apply(t){switch(console.log("APPLYING!"),t.type){case"token-manipulated":let i=this.tokens.get(t.id);if(!i)return void console.error("Update received for nonexistant token",t.id);Object.assign(i,{dim:t.dim,loc:t.loc,r:t.r});break;case"token-added":let s={id:t.id,dim:t.dim,loc:t.loc,res:t.res,r:0};this.tokens.add(t.id,s);break;case"grid-resized":this.grid_dim=t.dim;break;case"token-removed":const e=this.tokens.get(t.id);if(!e)return void console.error("Tried to remove nonexistant token",t.id);this.resources.delete(e.res),this.tokens.delete(e.id);break;case"state-sync":console.log("applying #tokens",t.tokens),this.tokens=new Gt;for(const i of t.tokens)this.tokens.add(i.id,i);this.grid_dim=t.grid_dim,this.#it=t.bg;break;case"token-reorder":const o=this.tokens.index(t.id);if(void 0===o)return void console.error("Tried to reorder non-existant token",t.id);let n;n="top"===t.idx?this.tokens.size-1:"bottom"===t.idx?0:"up"===t.idx?Math.min(this.tokens.size-1,o+1):Math.max(0,o-1),this.tokens.set_index(t.id,n);break;case"file":this.resources.register(t.contents,t.res_name);break;case"bg":this.#it&&this.resources.delete(this.#it),this.#it=t.res}this.dispatchEvent(new CustomEvent("updated"))}remove_token(t){this.apply({type:"token-removed",id:t})}apply(t){this.local_apply(t),this.dispatchEvent(new CustomEvent("game-event",{detail:t}))}set_dim(t){this.apply({type:"grid-resized",dim:t})}}
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let ni=class extends it{constructor(){super(...arguments),this.selection=[],this.host_pending=!1,this.#st=new oi,this.#et=()=>{this.#st.set_dim(At([1,1],[parseInt(this.width?.value)??0,parseInt(this.height?.value)??0]))},this.#ot=()=>{this.client&&!this.client.server&&this.client.connect()},this.#nt=()=>{this.client=void 0,window.history.pushState(null,"",window.location.href.split("?")[0])},this.#rt=async()=>{try{this.host_pending=!0;let t=await ti.establish();this.host_pending=!1,this.client=t,t.on_event=this.#ht,t.get_state=this.#st.get_state,t.get_images=()=>this.#st.resources.all(),window.history.pushState({},"","?game="+t.signaler.ident),navigator.clipboard.writeText(window.location.toString())}catch(t){console.error(t)}},this.#ht=t=>{this.#st.local_apply(t)},this.#lt=t=>{this.client?.send_event(t.detail)}}#st;render(){let t="error"===this.client?.status?O`<div class="message error"><div><h1>Error connecting to remote grid</h1><button @click="${this.#ot}">Try again</button> <button @click="${this.#nt}">New local grid</button></div></div>`:null,i="connecting"===this.client?.status?O`<div class="message"><div><h1>Connecting to grid...</h1></div></div>`:null,s="disconnected"===this.client?.status?O`<div class="message"><div><h1>Disconnected from host</h1><button @click="${this.#ot}">Try again</button> <button @click="${this.#nt}">Continue locally</button></div></div>`:null,e=t||i||s;return O`<section id="toolbar" class="group"><div class="group"><span>Grid: <input id="width" type="number" min="1" @input="${this.#et}" .value="${this.#st.grid_dim[0]+""}"> x <input id="height" type="number" min="1" @input="${this.#et}" .value="${this.#st.grid_dim[1]+""}"> </span>${1===this.selection.length?O`<div><button @click="${()=>this.#st.apply({type:"token-reorder",id:this.selection[0],idx:"down"})}" ?disabled="${0===this.#st.tokens.index(this.selection[0])}">Move Down</button> <button @click="${()=>this.#st.apply({type:"token-reorder",id:this.selection[0],idx:"up"})}" ?disabled="${this.#st.tokens.index(this.selection[0])===this.#st.tokens.size-1}">Move Up</button></div>`:null}</div><div class="group">${this.host_pending?O`<img src="assets/loading.svg">`:this.client?O`<div>${this.client.server?"hosting":this.client.status}</div>`:O`<button @click="${this.#rt}">Host</button>`}<buy-me-a-coffee class="right"></buy-me-a-coffee></div></section><bg-canvas bg="${(t=>null!=t?t:j)(this.#st.bg??void 0)}" .selection="${this.selection}" width="${this.#st.grid_dim[0]}" height="${this.#st.grid_dim[1]}" .tokens="${this.#st.tokens}" .resources="${this.#st.resources}" @token-drop="${({detail:t})=>this.#st.add_token(t.img,{loc:t.loc,r:0,dim:t.dim})}" @bg-drop="${({detail:t})=>this.#st.set_bg(t)}" @token-select="${({detail:t})=>{this.selection=t}}" @game-event="${({detail:t})=>this.#st.apply(t)}"></bg-canvas>${e}`}updated(t){t.has("client")&&(document.title="BattleGrid"+(this.client&&"connected"===this.client.status?this.client.server?"- Hosting":"- Connected":""))}#et;async connectedCallback(){super.connectedCallback(),this.#st.addEventListener("game-event",this.#lt),this.#st.addEventListener("updated",(()=>{this.selection=this.selection.filter((t=>this.#st.tokens.has(t))),this.requestUpdate(),this.canvas?.requestUpdate()}));let t=new URLSearchParams(window.location.search).get("game");if(!t)return{};let i=new ii(t);i.on_event=this.#ht,i.on_status=()=>this.requestUpdate("client"),this.client=i,await i.connect()}#ot;#nt;#rt;#ht;#lt};ni.styles=n`:host{width:100%;height:100%;display:grid;grid:"toolbar" 30px "viewport" 1fr/1fr;font-family:inherit;--ui-bg:#f9f9fa}.message{grid-area:1/1/3/1;display:grid;align-items:center;justify-items:center;background:#fff;z-index:2}.right{justify-self:end}bg-canvas{grid-area:viewport;z-index:1}input[type=number]{width:3em}.group{display:flex;align-items:center;height:100%;flex-wrap:nowrap}#toolbar{grid-area:toolbar;box-shadow:0 0 4px gray;z-index:2;background:var(--ui-bg);justify-content:space-between;padding:0 1em;grid-template-rows:unset}.group img{width:1em;height:1em;object-fit:cover;display:inline-block}`,t([at("#width",!0)],ni.prototype,"width",void 0),t([at("#height",!0)],ni.prototype,"height",void 0),t([at("bg-canvas",!0)],ni.prototype,"canvas",void 0),t([rt()],ni.prototype,"client",void 0),t([rt()],ni.prototype,"selection",void 0),t([rt()],ni.prototype,"host_pending",void 0),ni=t([et("bg-app")],ni),document.body.addEventListener("wheel",(t=>{console.log("HUH..."),t.ctrlKey&&t.preventDefault()}),{passive:!1});
