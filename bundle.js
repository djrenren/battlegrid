 ...
 */function Zt(t){const i=(new DOMParser).parseFromString(t,"text/html").querySelector("img")?.src;return i??null}const Gt=()=>([1e7]+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,(t=>(t^crypto.getRandomValues(new Uint8Array(1))[0]&15>>t/4).toString(16))),Kt=t=>new CustomEvent("game-event",{detail:t});class Vt{constructor(){this.order=[],this.map=new Map}get(t){const i=this.map.get(t);if(void 0!==i)return this.order[i]}has(t){return this.map.has(t)}add(t,i){this.map.set(t,this.order.length),this.order.push(i)}delete(t){const i=this.map.get(t);return void 0!==i&&(this.order.splice(i,1),this.map.delete(t),this.map.forEach(((t,s)=>{t>=i&&this.map.set(s,t-1)})),!0)}index(t){return this.map.get(t)}set_index(t,i){const s=this.map.get(t);if(void 0===s||i>=this.order.length)return!1;const e=this.order.splice(s,1)[0];return this.order.splice(i,0,e),this.map.forEach(((t,s)=>{t>=i&&this.map.set(s,t+1)})),this.map.set(t,i),!0}values(){return this.order}get size(){return this.map.size}}let qt=class extends it{constructor(){super(),this.width=30,this.height=40,this.tokens=new Vt,this.selection=new Set,this.#g=0,this.#f=t=>{mt(t),this.#g++},this.#w=t=>{mt(t);const i=this.#b(t).map(Yt),s=_t(kt([this.width,this.height],-1),72);this._drop_hint=Ut([0,0],s,i),this.hovering="canvas"},this.#m=t=>{--this.#g<=0&&(this._drop_hint=void 0,this.hovering=void 0)},this.#y=t=>{mt(t),this._drop_hint=void 0,this.hovering="bg"},this.#$=async t=>{mt(t);try{const i=await Wt(t);this.dispatchEvent(yt("bg-drop",i))}catch(t){}this.#g=0,this.hovering=void 0},this.#k=async t=>{mt(t);try{const i=await Wt(t);this.dispatchEvent(yt("token-drop",{loc:this._drop_hint,dim:[72,72],img:i}))}catch(t){}this._drop_hint=void 0,this.hovering=void 0},this.#x=t=>{if(!wt(t))return;t.preventDefault(),t.stopPropagation();const i=t.target.id;t.shiftKey||t.ctrlKey?this.dispatchEvent(yt("token-select",[i,...this.selection].filter((t=>t!==i||!this.selection.has(i))))):this.dispatchEvent(yt("token-select",[t.target.id]))},this.#_=t=>{ft(t)&&(mt(t),t.target.setPointerCapture(t.pointerId),this.#S=this.#b(t))},this.#C=t=>{if(mt(t),!t.shiftKey&&!t.ctrlKey)return;let i,s=-1;const e=this.#b(t);for(const t of this.tokens.values()){const o=this.tokens.get(t.id),n=this.tokens.index(t.id)??-1;n>s&&At(e,o.loc)&&Tt(xt(e,o.loc),o.dim)&&(s=n,i=t.id)}i&&this.dispatchEvent(yt("token-select",[...this.selection].filter((t=>t!==i||!this.selection.has(i)))))},this.#M={move:[0,0],resize:[0,0],r:0},this.#A=t=>{if(!ft(t))return;this.#S||this.#_(t),mt(t);const i=Ut([0,0],this.#T,this.#b(t)),s=this.tokens.get(this.selection.values().next().value),e=s.dim,o=s.loc,n=t.target.classList;let r=[0,0],h=[0,0],l=0;if(n.contains("rn")&&(h[1]=o[1]-Ft(i[1]),r[1]=Ft(i[1])-o[1]),n.contains("rw")&&(h[0]=o[0]-Ft(i[0]),r[0]=Ft(i[0])-o[0]),n.contains("rs")&&(h[1]=Ft(i[1])-e[1]-o[1]),n.contains("re")&&(h[0]=Ft(i[0])-e[0]-o[0]),n.contains("ro")){const t=$t(o,Mt(e,2)),n=xt(i,t),r=180*Math.atan2(n[0],-n[1])/Math.PI;l=90*Math.round(r/90)-s.r%360}n.contains("selection-box")?r=xt(i,this.#S).map(Ft):(r=Rt(kt(e,-72),r),h=Et(kt(_t(e,-1),72),h)),l===this.#M.r&&zt(r,this.#M.move)&&zt(h,this.#M.resize)||(this.#S=$t(this.#S,r),this.#M={move:[0,0],resize:[0,0],r:0},this.dispatchEvent(Kt({type:"token-manipulated",tokens:Array.from(this.selection,(t=>{let i=this.tokens.get(t);return{id:i.id,loc:$t(i.loc,r),dim:$t(i.dim,h),r:i.r+l}}))})))},this.#E=t=>{mt(t),this.#S=void 0},this.#b=t=>xt(this.viewport.coordToLocal([t.clientX,t.clientY]),[60,60]),this.#o=t=>{if(!this.selection)return;if(8===t.keyCode)return this.dispatchEvent(Kt({type:"token-removed",ids:Array.from(this.selection)})),void mt(t);this.tokens.get(this.selection.values().next().value);let i={ArrowUp:[0,-72],ArrowDown:[0,72],ArrowLeft:[-72,0],ArrowRight:[72,0]}[t.key];i&&(this.dispatchEvent(Kt({type:"token-manipulated",tokens:Array.from(this.selection,(t=>{const s=this.tokens.get(t),e=Ut([0,0],xt(this.#T,s.dim),$t(s.loc,i));return{id:s.id,loc:e,dim:s.dim,r:s.r}}))})),mt(t))}}#R;get#T(){return _t([this.width,this.height],72)}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.#o)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this.#o)}render(){let[t,i]=this.#T,s=this.#U(),e=1===this.selection.size?this.tokens.get(this.selection.values().next().value):void 0;return O`
      ...
      >
        <svg id="root" width=${t+120} height=${i+120}>
          ...
          `:null}
            ...
            ${this.#R?N`
              <rect id="sbox"
                x=${Math.min(this.#R.pin[0],this.#R.mouse[0])}
                y=${Math.min(this.#R.pin[1],this.#R.mouse[1])}
                width=${Math.abs(this.#R.pin[0]-this.#R.mouse[0])}
                height=${Math.abs(this.#R.pin[1]-this.#R.mouse[1])}
                ></rect>
              `:null}
            ${s?N`
            <svg
    ...
    `}createRenderRoot(){return super.createRenderRoot()}#g;#f;#w;#m;#y;#$;#k;#x;#z(t){if(!wt(t))return;t.target.setPointerCapture(t.pointerId);const i=this.#b(t);this.#R={pin:i,mouse:i}}#O(t){this.#R&&(this.#R.mouse=this.#b(t),this.requestUpdate())}#N(t){if(!this.#R)return;t.target.setPointerCapture(t.pointerId);const i=Rt(this.#R.pin,this.#R.mouse),s=(t=>[Math.abs(t[0]),Math.abs(t[1])])(xt(this.#R.pin,this.#R.mouse)),e={start:i,end:$t(i,s)};console.log("box",e);const o=this.tokens.order.filter((t=>((t,i)=>!(i.start[0]>t.end[0]||i.end[0]<t.start[0]||i.start[1]>t.end[1]||i.end[1]<t.start[1]))(e,{start:t.loc,end:$t(t.loc,t.dim)}))).map((t=>t.id));console.log(o),this.#R=void 0,this.dispatchEvent(yt("token-select",o)),this.requestUpdate()}#U(){if(0===this.selection.size)return;const t=Array.from(this.selection,(t=>this.tokens.get(t))).filter((t=>t));let i=t[0].loc,s=$t(t[0].loc,t[0].dim);return t.forEach((t=>{i=Rt(i,t.loc),s=Et(s,$t(t.loc,t.dim))})),{start:i,end:s}}#S;#_;#C;#M;#A;#E;#b;#o};qt.styles=n`
    :host {
      position: relative;
      display: block;
  ...
  `,t([nt({type:Number})],qt.prototype,"width",void 0),t([nt({type:Number})],qt.prototype,"height",void 0),t([nt()],qt.prototype,"bg",void 0),t([nt({attribute:!1})],qt.prototype,"tokens",void 0),t([nt({attribute:!1})],qt.prototype,"resources",void 0),t([nt({attribute:!1})],qt.prototype,"selection",void 0),t([nt({attribute:!1})],qt.prototype,"sel_bbox",void 0),t([at("root",!0)],qt.prototype,"root",void 0),t([at("bg-viewport",!0)],qt.prototype,"viewport",void 0),t([rt()],qt.prototype,"_drop_hint",void 0),t([rt()],qt.prototype,"hovering",void 0),qt=t([et("bg-canvas")],qt);const Ft=t=>72*Math.round(t/72),Yt=t=>t-t%72,Qt={iceServers:[{urls:"stun:stun.l.google.com:19302"}]};class Xt{constructor(t){this.#P=()=>{},this.#j=new RTCPeerConnection(Qt),this.#L=!1,this.#P=t,this.#D()}#P;#j;#L;async initiate(){this.#L=!0;let t=await this.#j.createOffer();await this.#j.setLocalDescription(t),this.#P({type:"offer",offer:t})}#D(){null!==this.#j.localDescription&&(this.#j.onicecandidate=null,this.#j.onconnectionstatechange=null,this.#j.close()),this.#j=new RTCPeerConnection(Qt),this.data=this.#j.createDataChannel("data",{ordered:!0,negotiated:!0,id:1}),this.events=this.#j.createDataChannel("control",{ordered:!0,negotiated:!0,id:2}),this.#j.onicecandidate=({candidate:t})=>{null!==t&&this.#P({type:"icecandidate",candidate:t})},this.#j.onconnectionstatechange=()=>{"closed"===this.#j.connectionState&&(this.#D(),this.#L&&this.initiate())}}async signal(t){console.log("received",t);let i=this.#j.signalingState;switch(t.type){case"offer":if("stable"!==i)return void console.error(`Received offer at incorrect state: ${i}. Ignoring.`);this.#j.setRemoteDescription(new RTCSessionDescription(t.offer));const s=await this.#j.createAnswer();await this.#j.setLocalDescription(s),this.#P({type:"answer",answer:s});break;case"answer":if("have-local-offer"!==i)return void console.error(`Received answer at incorrect state: ${i}. Ignoring.`);this.#j.setRemoteDescription(new RTCSessionDescription(t.answer));break;case"icecandidate":await this.#j.addIceCandidate(t.candidate)}}}class ti extends EventTarget{constructor(t,i){super(),this.#I=!1,this.#B="connected",this.#J=new Map,this.#H=t,this.#W=i}#H;#W;#I;#B;#J;get ident(){return this.#H}get status(){return this.#B}static async establish(t,i){i&&(t.pathname="/"+i);let s=await this.#Z(t);return console.log("acquired socket for ",i),new Promise(((t,i)=>{s.addEventListener("message",(e=>{let o=JSON.parse(e.data);s.removeEventListener("close",i);let n=new ti(o.id,s);n.#G(),t(n)}),{once:!0}),s.addEventListener("close",i)}))}static async#Z(t){return new Promise(((i,s)=>{let e=new WebSocket(t.toString());e.addEventListener("close",(t=>s(t)),{once:!0}),e.addEventListener("open",(()=>{console.log("WS CONNECTED"),e.removeEventListener("close",s),i(e)}))}))}#G(){let t=new URL(this.#W.url);this.#W.addEventListener("error",(t=>{this.dispatchEvent(new CustomEvent("error",{detail:t}))})),this.#W.addEventListener("close",(()=>this.#K(t))),this.#W.addEventListener("message",(t=>{let i=JSON.parse(t.data);this.#V(i)}))}async connect_to(t){let i=new Xt((i=>{this.#W.send(JSON.stringify({target:t,...i})),"shutdown"===i.type&&this.#J.delete(i.from)}));return this.#J.set(t,i),await i.initiate(),i}#q(t){this.#B=t,this.dispatchEvent(new CustomEvent("status",{detail:t}))}async#K(t){let i;if(t.pathname="/"+this.#H,this.#I)this.#q("closed");else{this.#q("disconnected");try{i=await ti.#Z(t)}catch(t){return console.error("Error reconnecting",t),void setTimeout((()=>this.#K),1e3)}this.#W=i,this.#G(),this.#q("connected")}}_disconnect(){this.#W.close()}close(){this.#I=!0,this.#W.close()}#V(t){if(console.log(t),t.error)this.dispatchEvent(new CustomEvent("error",{detail:t.error}));else if("offer"!==t.type||this.#J.has(t.from))this.#J.get(t.from)?.signal(t),"shutdown"===t.type&&this.#J.delete(t.from);else{let i=new Xt((i=>{this.#W.send(JSON.stringify({target:t.from,...i})),"shutdown"===t.type&&this.#J.delete(t.from)}));this.#J.set(t.from,i),i.signal(t),this.dispatchEvent(new CustomEvent("peer",{detail:i}))}}}const ii=t=>{let i=(t=>new ReadableStream({start(i){t.onmessage=({data:t})=>i.enqueue(t);const s=()=>{i.close(),t.removeEventListener("close",s)};t.addEventListener("close",s)},cancel(){t.close()}}))(t).pipeThrough((()=>{let t,i=[];return new TransformStream({start(){},async transform(s,e){if("string"==typeof s){let i=JSON.parse(s);if("event"===i.type)return void e.enqueue(i.event);t=i}else{if(!t)return;if(i.push(s),0==--t.chunks)return e.enqueue({type:"file",res_name:t.res_name,contents:new Blob(i)}),void(i=[])}},flush(){i=[]}})})()),s=new TransformStream({start(){},async transform(t,i){if("file"===t.type){i.enqueue(JSON.stringify({type:"file",res_name:t.res_name,chunks:Math.ceil(t.contents.size/64e3)}));for(let s=0;s<t.contents.size;s+=64e3)i.enqueue(await t.contents.slice(s,Math.min(s+64e3,t.contents.size)).arrayBuffer())}else i.enqueue(JSON.stringify({type:"event",event:t}))}});return s.readable.pipeTo((t=>{let i;return new WritableStream({start(s){const e=()=>{s.error("Closed"),t.removeEventListener("close",e)};t.addEventListener("close",e),t.onopen=()=>i&&i(),t.onbufferedamountlow=()=>i&&i()},async write(s){("connecting"===t.readyState||t.bufferedAmount>t.bufferedAmountLowThreshold)&&await new Promise(((t,s)=>i=t)),t.send(s)},abort(){t.close()}},new CountQueuingStrategy({highWaterMark:1}))})(t)),{writable:s.writable,readable:i}};class si{constructor(t){this.server=this,this.#F=new Set,this.#Y=new Set,this.on_event=()=>{},this.signaler=t;let{readable:i,writable:s}=new TransformStream({start(){},transform(t,i){console.log("TF STREAM"),i.enqueue(t)},flush(){}}),e=i.getReader(),o=s.getWriter();this.signaler.addEventListener("peer",(async({detail:t})=>{let i=ii(t.events),s=ii(t.data);const e=i.writable.getWriter(),n=s.writable.getWriter();this.#F.add(e),this.#Y.add(n),console.log("Getting state"),this.get_state&&(console.log("state",this.get_state()),e.write(this.get_state())),console.log("writing images");for(const[t,i]of this.get_images?this.get_images():[])console.log(t,i),n.write({type:"file",res_name:t,contents:await(await fetch(i)).blob()});(async()=>{let t,s,n=i.readable.getReader();for(;({value:t,done:s}=await n.read())&&!s;)await o.write({author:e,ev:t});this.#F.delete(e)})(),(async()=>{let t,i,r=s.readable.getReader();for(;({value:t,done:i}=await r.read())&&!i;)await o.write({author:e,ev:t});this.#Y.delete(n)})()})),(async()=>{let t,i,s;for(;({value:{author:s,ev:t},done:i}=await e.read())&&!i;)await this.send_event(t,s),this.on_event(t)})()}get status(){return"connected"===this.signaler.status?"connected":"disconnected"}#F;#Y;async send_event(t,i){let s="file"===t.type?this.#Y:this.#F;await Promise.all(Array.from(s).filter((t=>t!==i)).map((i=>i.write(t))))}static async establish(){return new si(await ti.establish(new URL("wss://battlegrid-signaling.herokuapp.com/")))}}class ei{constructor(t){this.status="disconnected",this.server=void 0,this.on_event=t=>{},this.on_status=()=>{},this.#Q=t}#X;#tt;#Q;#q(t){this.status=t,setTimeout(this.on_status,0)}async connect(){let t;this.#q("connecting");try{let i=await ti.establish(new URL("wss://battlegrid-signaling.herokuapp.com"));t=await new Promise((async(t,s)=>{i.addEventListener("error",s,{once:!0});let e=await i.connect_to(this.#Q);e.data.onopen=()=>t(e)}))}catch(t){return console.log("error"),void this.#q("error")}let i=ii(t.events);this.#X=i.writable.getWriter();let s=i.readable.getReader(),e=ii(t.data);this.#tt=e.writable.getWriter();let o=e.readable.getReader();this.#q("connected"),(async()=>{let t,i;for(;({value:t,done:i}=await o.read())&&!i;)console.log("DATA",t),this.on_event(t);console.log("dccccc"),this.#q("disconnected")})(),(async()=>{let t,i;for(;({value:t,done:i}=await s.read())&&!i;)console.log("EVENT!",t),this.on_event(t);console.log("dccccc"),this.#q("disconnected")})()}async send_event(t){("file"===t.type?this.#tt:this.#X)?.write(t)}}let oi=class extends it{constructor(){super(...arguments),this._state=!1,this._loaded=!1,this._buy=t=>{console.log("CLICK"),mt(t),this._state=!0,document.addEventListener("click",this.#it,{capture:!0})},this.#it=t=>{mt(t),this._state=!1,document.removeEventListener("click",this.#it,{capture:!0})},this.#st=t=>{this._loaded=!0}}render(){return O`<button @click="${this._buy}">Buy Me A Coffee</button> ${this._state?O`<div id="container"><iframe class="${this._loaded?"loaded":""}" allow="payment" src="https://ko-fi.com/djrenren/?hidefeed=true&widget=true&embed=true&preview=true" title="djrenren" @load="${this.#st}"></iframe></div>`:null}`}#it;#st};oi.styles=n`:host{display:block;position:relative}iframe{border:none;display:block;opacity:0;width:100%;height:100%;transition:opacity .5s linear}#container{border-radius:5px;box-shadow:0 0 6px rgba(0,0,0,.7);position:absolute;width:350px;height:525px;bottom:-535px;right:0;animation-name:fade;animation-duration:.5s;animation-direction:backwards;background:url(assets/loading.svg) center/100px no-repeat,#ededf0;overflow:hidden}iframe.loaded{opacity:1}@keyframes fade{0%{opacity:0}100%{opacity:1}}`,t([rt()],oi.prototype,"_state",void 0),t([rt()],oi.prototype,"_loaded",void 0),oi=t([et("buy-me-a-coffee")],oi);class ni{constructor(){this.index=new Set}get(t){return t.startsWith("local:")?window.sessionStorage.getItem(t):t}delete(t){const i=this.get(t);return!!i&&(URL.revokeObjectURL(i),window.sessionStorage.removeItem(t),!0)}register(t,i){if("string"==typeof t)return t;let s=i??"local:"+Gt();return this.index.add(s),window.sessionStorage.setItem(s,URL.createObjectURL(t)),s}*all(){for(let t of this.index.values())yield[t,this.get(t)]}}class ri extends EventTarget{constructor(){super(...arguments),this.tokens=new Vt,this.grid_dim=[30,20],this.resources=new ni,this.get_state=()=>({type:"state-sync",tokens:[...this.tokens.values()],grid_dim:this.grid_dim,bg:this.#et})}#et;get bg(){return this.#et?this.resources.get(this.#et):null}set_bg(t){const i=t?this.resources.register(t):void 0;this.apply({type:"bg",res:i}),t instanceof Blob&&this.dispatchEvent(Kt({type:"file",res_name:i,contents:t}))}add_token(t,i){const s=Gt(),e=this.resources.register(t),o={id:s,res:e,...i};this.apply({type:"token-added",...o}),t instanceof Blob&&this.dispatchEvent(Kt({type:"file",res_name:e,contents:t}))}local_apply(t){switch(console.log("APPLYING!"),t.type){case"token-manipulated":for(let i of t.tokens){let t=this.tokens.get(i.id);if(!t)return void console.error("Update received for nonexistant token",i.id);Object.assign(t,{dim:i.dim,loc:i.loc,r:i.r})}break;case"token-added":let i={id:t.id,dim:t.dim,loc:t.loc,res:t.res,r:0};this.tokens.add(t.id,i);break;case"grid-resized":this.grid_dim=t.dim;break;case"token-removed":for(let i of t.ids){const t=this.tokens.get(i);if(!t)return void console.error("Tried to remove nonexistant token",i);this.resources.delete(t.res),this.tokens.delete(t.id)}break;case"state-sync":console.log("applying #tokens",t.tokens),this.tokens=new Vt;for(const i of t.tokens)this.tokens.add(i.id,i);this.grid_dim=t.grid_dim,this.#et=t.bg;break;case"token-reorder":const s=this.tokens.index(t.id);if(void 0===s)return void console.error("Tried to reorder non-existant token",t.id);let e;e="top"===t.idx?this.tokens.size-1:"bottom"===t.idx?0:"up"===t.idx?Math.min(this.tokens.size-1,s+1):Math.max(0,s-1),this.tokens.set_index(t.id,e);break;case"file":this.resources.register(t.contents,t.res_name);break;case"bg":this.#et&&this.resources.delete(this.#et),this.#et=t.res}this.dispatchEvent(new CustomEvent("updated"))}remove_token(t){this.apply({type:"token-removed",ids:[t]})}apply(t){this.local_apply(t),this.dispatchEvent(new CustomEvent("game-event",{detail:t}))}set_dim(t){this.apply({type:"grid-resized",dim:t})}}
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const hi=t=>t[Symbol.iterator]().next().value;let li=class extends it{constructor(){super(...arguments),this.selection=new Set,this.host_pending=!1,this.#ot=new ri,this.#nt=()=>{this.#ot.set_dim(Et([1,1],[parseInt(this.width?.value)??0,parseInt(this.height?.value)??0]))},this.#rt=()=>{this.client&&!this.client.server&&this.client.connect()},this.#ht=()=>{this.client=void 0,window.history.pushState(null,"",window.location.href.split("?")[0])},this.#lt=async()=>{try{this.host_pending=!0;let t=await si.establish();this.host_pending=!1,this.client=t,t.on_event=this.#at,t.get_state=this.#ot.get_state,t.get_images=()=>this.#ot.resources.all(),window.history.pushState({},"","?game="+t.signaler.ident),navigator.clipboard.writeText(window.location.toString())}catch(t){console.error(t)}},this.#at=t=>{this.#ot.local_apply(t)},this.#ct=t=>{this.client?.send_event(t.detail)}}#ot;render(){let t="error"===this.client?.status?O`<div class="message error"><div><h1>Error connecting to remote grid</h1><button @click="${this.#rt}">Try again</button> <button @click="${this.#ht}">New local grid</button></div></div>`:null,i="connecting"===this.client?.status?O`<div class="message"><div><h1>Connecting to grid...</h1></div></div>`:null,s="disconnected"===this.client?.status?O`<div class="message"><div><h1>Disconnected from host</h1><button @click="${this.#rt}">Try again</button> <button @click="${this.#ht}">Continue locally</button></div></div>`:null,e=t||i||s;return O`<section id="toolbar" class="group"><div class="group"><span>Grid: <input id="width" type="number" min="1" @input="${this.#nt}" .value="${this.#ot.grid_dim[0]+""}"> x <input id="height" type="number" min="1" @input="${this.#nt}" .value="${this.#ot.grid_dim[1]+""}"> </span>${1===this.selection.size?O`<div><button @click="${()=>this.#ot.apply({type:"token-reorder",id:hi(this.selection),idx:"down"})}" ?disabled="${0===this.#ot.tokens.index(hi(this.selection))}">Move Down</button> <button @click="${()=>this.#ot.apply({type:"token-reorder",id:hi(this.selection),idx:"up"})}" ?disabled="${this.#ot.tokens.index(hi(this.selection))===this.#ot.tokens.size-1}">Move Up</button></div>`:null}</div><div class="group">${this.host_pending?O`<img src="assets/loading.svg">`:this.client?O`<div>${this.client.server?"hosting":this.client.status}</div>`:O`<button @click="${this.#lt}">Host</button>`}<buy-me-a-coffee class="right"></buy-me-a-coffee></div></section><bg-canvas bg="${(t=>null!=t?t:j)(this.#ot.bg??void 0)}" .selection="${this.selection}" width="${this.#ot.grid_dim[0]}" height="${this.#ot.grid_dim[1]}" .tokens="${this.#ot.tokens}" .resources="${this.#ot.resources}" @token-drop="${({detail:t})=>this.#ot.add_token(t.img,{loc:t.loc,r:0,dim:t.dim})}" @bg-drop="${({detail:t})=>this.#ot.set_bg(t)}" @token-select="${({detail:t})=>{this.selection=new Set(t)}}" @game-event="${({detail:t})=>this.#ot.apply(t)}"></bg-canvas>${e}`}updated(t){t.has("client")&&(document.title="BattleGrid"+(this.client&&"connected"===this.client.status?this.client.server?"- Hosting":"- Connected":""))}#nt;async connectedCallback(){super.connectedCallback(),this.#ot.addEventListener("game-event",this.#ct),this.#ot.addEventListener("updated",(()=>{for(const t of this.selection)this.#ot.tokens.has(t)||this.selection.delete(t);this.requestUpdate(),this.canvas?.requestUpdate()}));let t=new URLSearchParams(window.location.search).get("game");if(!t)return{};let i=new ei(t);i.on_event=this.#at,i.on_status=()=>this.requestUpdate("client"),this.client=i,await i.connect()}#rt;#ht;#lt;#at;#ct};li.styles=n`:host{width:100%;height:100%;display:grid;grid:"toolbar" 30px "viewport" 1fr/1fr;font-family:inherit;--ui-bg:#f9f9fa}.message{grid-area:1/1/3/1;display:grid;align-items:center;justify-items:center;background:#fff;z-index:2}.right{justify-self:end}bg-canvas{grid-area:viewport;z-index:1}input[type=number]{width:3em}.group{display:flex;align-items:center;height:100%;flex-wrap:nowrap}#toolbar{grid-area:toolbar;box-shadow:0 0 4px gray;z-index:2;background:var(--ui-bg);justify-content:space-between;padding:0 1em;grid-template-rows:unset}.group img{width:1em;height:1em;object-fit:cover;display:inline-block}`,t([at("#width",!0)],li.prototype,"width",void 0),t([at("#height",!0)],li.prototype,"height",void 0),t([at("bg-canvas",!0)],li.prototype,"canvas",void 0),t([rt()],li.prototype,"client",void 0),t([rt()],li.prototype,"selection",void 0),t([rt()],li.prototype,"host_pending",void 0),li=t([et("bg-app")],li),document.body.addEventListener("wheel",(t=>{console.log("HUH..."),t.ctrlKey&&t.preventDefault()}),{passive:!1});
