        ...
        <svg id="root" width=${e+120} height=${o+120}>
          ...
          <g transform=${"translate(60 60)"}>
            ...
            <g style="clip-path: url(#canvasClip)">
              ...
              ${Dt(this.tokens.values(),(t=>t.id),((e,o)=>{const n=this.resources.get(e.res),r=this.selection===e.id;let h=r?s:e.r;const l=(r?t[0]:e.dim[0])-1.5,a=(r?t[1]:e.dim[1])-1.5,c=(r?i[0]:e.loc[0])+.75,d=(r?i[1]:e.loc[1])+.75;return N`
