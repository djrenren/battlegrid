 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */;function at(t){return ht({finisher:(i,e)=>{Object.assign(i.prototype[e],t)}})}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function lt(t,i){return ht({descriptor:e=>{const s={get(){var i,e;return null!==(e=null===(i=this.renderRoot)||void 0===i?void 0:i.querySelector(t))&&void 0!==e?e:null},enumerable:!0,configurable:!0};if(i){const i="symbol"==typeof e?Symbol():"__"+e;s.get=function(){var e,s;return void 0===this[i]&&(this[i]=null!==(s=null===(e=this.renderRoot)||void 0===e?void 0:e.querySelector(t))&&void 0!==s?s:null),this[i]}}return s}})}
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const gt=vt(class extends pt{constructor(t){var i;if(super(t),t.type!==dt||"style"!==t.name||(null===(i=t.strings)||void 0===i?void 0:i.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((i,e)=>{const s=t[e];return null==s?i:i+`${e=e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`}),"")}update(t,[i]){const{style:e}=t.element;if(void 0===this.ct){this.ct=new Set;for(const t in i)this.ct.add(t);return this.render(i)}this.ct.forEach((t=>{null==i[t]&&(this.ct.delete(t),t.includes("-")?e.removeProperty(t):e[t]="")}));for(const t in i){const s=i[t];null!=s&&(this.ct.add(t),t.includes("-")?e.setProperty(t,s):e[t]=s)}return P}}),ft=t=>t.isPrimary&&("touch"===t.pointerType||t.pressure>0),wt=t=>"touch"!==t.pointerType&&t.isPrimary&&t.pressure>0,bt=t=>{t.preventDefault(),t.stopPropagation()},mt=(t,i)=>new CustomEvent(t,{detail:i}),yt=(t,i)=>[t[0]+i[0],t[1]+i[1]],$t=(t,i)=>yt(t,[i,i]),kt=(t,i)=>[t[0]-i[0],t[1]-i[1]],_t=(t,i)=>[t[0]*i,t[1]*i],xt=(t,i)=>[t[0]*i[0],t[1]*i[1]],St=(t,i)=>[t[0]/i[0],t[1]/i[1]],Ct=(t,i)=>[t[0]/i,t[1]/i],At=(t,i)=>[Math.max(t[0],i[0]),Math.max(t[1],i[1])],Mt=(t,i)=>[Math.min(t[0],i[0]),Math.min(t[1],i[1])],Tt=(t,i,e)=>At(t,Mt(i,e)),Et=(t,i)=>t[0]===i[0]&&t[1]===i[1];let Rt=class extends it{constructor(){super(...arguments),this.scale=1,this.c_dim=[0,0],this.v_dim=[0,0],this.v_loc=[0,0],this._scrollPos=[0,0],this.smooth=0,this.#t=0,this.#i=[0,0],this.#e=new ResizeObserver((t=>{for(let i of t)switch(i.target){case this.surface:this.v_dim=[i.contentRect.width,i.contentRect.height];const t=this.getBoundingClientRect();this.v_loc=[t.x,t.y],this.smooth=0;break;case this.#s:this.c_dim=[this.#s.width.baseVal.value,this.#s.height.baseVal.value]}})),this.#o=t=>{t.ctrlKey&&("="===t.key?(bt(t),this.smooth=200,this._performZoom(this.coordToLocal(Ct(yt(this.v_loc,this.v_dim),2)),.2*this.scale)):"-"===t.key?(bt(t),this.smooth=200,this._performZoom(this.coordToLocal(Ct(yt(this.v_loc,this.v_dim),2)),-.2*this.scale)):"0"===t.key&&(this.smooth=100,this.#n()))},this.#r=[0,0],this.#h=t=>{bt(t),t.target.setPointerCapture(t.pointerId),this.#r=[t.clientX,t.clientY]},this.#a=(t,i,e,s)=>{this.smooth=0;let o=this.#l,n=this.#r;this.#r=[t.clientX,t.clientY],this.#l=[i?o[0]+s*(this.#r[0]-n[0]):o[0],e?o[1]+s*(this.#r[1]-n[1]):o[1]]},this.#c=t=>{t.target.releasePointerCapture(t.pointerId)},this._touchdragstart=t=>{t.isPrimary&&"touch"===t.pointerType&&this.#h(t)},this._touchdragmove=t=>{t.isPrimary&&"touch"===t.pointerType&&this.#a(t,!0,!0,-1)},this._touchdragend=t=>{t.isPrimary&&"touch"===t.pointerType&&this.#c(t)}}#s;get#l(){return At([0,0],Mt(this._scrollPos,kt(_t(this.c_dim,this.scale),this.v_dim)))}set#l(t){const i=this._scrollPos;this._scrollPos=t,this.requestUpdate("#scrollPos",i)}get offset(){return At([0,0],_t(kt(this.v_dim,_t(this.c_dim,this.scale)),.5)).map((t=>t))}render(){const t=this.offset,i=this.#l;let e=!1,s=!1;this.v_dim&&this.c_dim&&(e=this.v_dim[1]<this.c_dim[1]*this.scale,s=this.v_dim[0]<this.c_dim[0]*this.scale);const o=St(xt(this.v_dim,this.v_dim),_t(this.c_dim,this.scale)),n=St(xt(i,this.v_dim),_t(this.c_dim,this.scale));return z`<style>:host,:root{--scale:${this.scale}}::slotted(svg){transform:translate(${t[0]-i[0]}px,${t[1]-i[1]}px) scale(var(--scale))}*,::slotted(svg){transition-duration:${this.smooth+"ms"}}</style><div id="touch-surface" @wheel="${this._wheel}" @pointerdown="${this._touchdragstart}" @pointermove="${this._touchdragmove}" @pointerup="${this._touchdragend}" @gesturestart="${this._gesturestart}" @gesturechange="${this._gesturechange}"><div id="bg" part="background"></div><slot @slotchange="${this.handleSlotchange}"></slot><div part="bar" class="bottombar" style="${gt({transform:`translate(${n[0]}px, 0)`,width:`${o[0]}px`,display:s?"block":"none"})}" @pointerdown="${this.#d}" @pointermove="${this.#u}" @pointerup="${this.#v}"></div><div part="bar" class="rightbar" style="${gt({transform:`translate(0, ${n[1]}px)`,height:`${o[1]}px`,display:e?"block":"none"})}" @pointerdown="${this.#d}" @pointermove="${this.#p}" @pointerup="${this.#v}"></div></div>`}#d(t){wt(t)&&this.#h(t)}#u(t){wt(t)&&this.#a(t,!0,!1,this.c_dim[0]*this.scale/this.v_dim[0])}#p(t){wt(t)&&this.#a(t,!1,!0,this.c_dim[1]*this.scale/this.v_dim[1])}#v(t,i){this.#c(t)}_wheel(t){bt(t);const i=t.deltaMode===WheelEvent.DOM_DELTA_LINE?10:1;if(t.ctrlKey){const e=Math.min(50,Math.max(-50,-t.deltaY*i)),s=.005*e*this.scale;this.smooth=50===Math.abs(e)?300:0,this._performZoom(this.coordToLocal([t.clientX,t.clientY]),s)}else{const e=_t([t.deltaX,t.deltaY],i);this.smooth=2*(Math.abs(e[0])+Math.abs(e[1])),this.smooth=0,this.#l=yt(e,this.#l)}}#t;#i;_gesturestart(t){this.#i=this.coordToLocal([t.clientX,t.clientY]),this.#t=1,bt(t)}_gesturechange(t){bt(t),this._performZoom(this.#i,this.scale*(t.scale-this.#t)*1.5),this.#t=t.scale}_performZoom(t,i){let e=Math.min(1,Math.max(.2,this.scale+i)),s=e-this.scale;this.#l=yt(_t(t,s),this.#l),this.scale=e}#e;firstUpdated(){this.#e.observe(this.surface)}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.#o)}disconnectedCallback(){super.disconnectedCallback(),this.#e.disconnect(),document.removeEventListener("keydown",this.#o)}#o;coordToLocal(t){const i=yt(kt(t,this.v_loc),this.#l);return Ct(kt(i,this.offset),this.scale)}handleSlotchange({target:t}){this.#s&&this.#e.unobserve(this.#s),this.#s=t.assignedElements().find((t=>t.matches("svg"))),this.#n(),this.#s&&this.#e.observe(this.#s)}#n(){const t=[this.#s.width.baseVal.value,this.#s.height.baseVal.value],i=this.surface.getBoundingClientRect();this.scale=Math.max(.2,Math.min(1,..._t(St([i.width,i.height],t),.95)))}#r;#h;#a;#c;static get styles(){return n`#touch-surface{position:relative;width:100%;height:100%;overflow:clip}::slotted(svg){transform-origin:0 0;position:absolute}.bottombar{position:fixed;bottom:0;height:var(--thickness);transform-origin:0 0;backface-visibility:hidden;will-change:width}.rightbar{position:fixed;width:var(--thickness);transform-origin:0 0;backface-visibility:hidden;right:0;will-change:height}*,::slotted(svg){transition-property:all}#bg{position:absolute;z-index:-1;height:100%;width:100%}`}};t([nt({type:Number})],Rt.prototype,"scale",void 0),t([rt()],Rt.prototype,"c_dim",void 0),t([rt()],Rt.prototype,"v_dim",void 0),t([rt()],Rt.prototype,"v_loc",void 0),t([rt()],Rt.prototype,"_scrollPos",void 0),t([lt("#touch-surface",!0)],Rt.prototype,"surface",void 0),t([rt()],Rt.prototype,"smooth",void 0),t([at({passive:!1,capture:!0})],Rt.prototype,"_wheel",null),t([at({capture:!0})],Rt.prototype,"_gesturestart",null),t([at({passive:!1})],Rt.prototype,"_gesturechange",null),Rt=t([st("bg-viewport")],Rt);const Ot=()=>{document.documentElement.style.setProperty("--app-height",`${window.innerHeight}px`)};window.addEventListener("resize",Ot),Ot();
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const{H:Ut}=F,zt=()=>document.createComment(""),Nt=(t,i,e)=>{var s;const o=t._$AA.parentNode,n=void 0===i?t._$AB:i._$AA;if(void 0===e){const i=o.insertBefore(zt(),n),s=o.insertBefore(zt(),n);e=new Ut(i,s,t,t.options)}else{const i=e._$AB.nextSibling,r=e._$AM,h=r!==t;if(h){let i;null===(s=e._$AQ)||void 0===s||s.call(e,t),e._$AM=t,void 0!==e._$AP&&(i=t._$AU)!==r._$AU&&e._$AP(i)}if(i!==n||h){let t=e._$AA;for(;t!==i;){const i=t.nextSibling;o.insertBefore(t,n),t=i}}}return e},Pt=(t,i,e=t)=>(t._$AI(i,e),t),jt={},Lt=t=>{var i;null===(i=t._$AP)||void 0===i||i.call(t,!1,!0);let e=t._$AA;const s=t._$AB.nextSibling;for(;e!==s;){const t=e.nextSibling;e.remove(),e=t}},Dt=(t,i,e)=>{const s=new Map;for(let o=i;o<=e;o++)s.set(t[o],o);return s},It=vt(class extends pt{constructor(t){if(super(t),t.type!==ut)throw Error("repeat() can only be used in text expressions")}dt(t,i,e){let s;void 0===e?e=i:void 0!==i&&(s=i);const o=[],n=[];let r=0;for(const i of t)o[r]=s?s(i,r):r,n[r]=e(i,r),r++;return{values:n,keys:o}}render(t,i,e){return this.dt(t,i,e).values}update(t,[i,e,s]){var o;const n=(t=>t._$AH)(t),{values:r,keys:h}=this.dt(i,e,s);if(!Array.isArray(n))return this.at=h,r;const a=null!==(o=this.at)&&void 0!==o?o:this.at=[],l=[];let c,d,u=0,v=n.length-1,p=0,g=r.length-1;for(;u<=v&&p<=g;)if(null===n[u])u++;else if(null===n[v])v--;else if(a[u]===h[p])l[p]=Pt(n[u],r[p]),u++,p++;else if(a[v]===h[g])l[g]=Pt(n[v],r[g]),v--,g--;else if(a[u]===h[g])l[g]=Pt(n[u],r[g]),Nt(t,l[g+1],n[u]),u++,g--;else if(a[v]===h[p])l[p]=Pt(n[v],r[p]),Nt(t,n[u],n[v]),v--,p++;else if(void 0===c&&(c=Dt(h,p,g),d=Dt(a,u,v)),c.has(a[u]))if(c.has(a[v])){const i=d.get(h[p]),e=void 0!==i?n[i]:null;if(null===e){const i=Nt(t,n[u]);Pt(i,r[p]),l[p]=i}else l[p]=Pt(e,r[p]),Nt(t,n[u],e),n[i]=null;p++}else Lt(n[v]),v--;else Lt(n[u]),u++;for(;p<=g;){const i=Nt(t,l[g+1]);Pt(i,r[p]),l[p++]=i}for(;u<=v;){const t=n[u++];null!==t&&Lt(t)}return this.at=h,((t,i=jt)=>{t._$AH=i})(t,l),P}}),Jt=async t=>{let i=t.dataTransfer?.items??[];return new Promise((async(t,e)=>{console.log("DataItems",i.length);for(let e=0;e<i.length;e++){if(console.log(i[e].type),i[e].type.startsWith("image/"))return t(i[e].getAsFile());if("text/html"===i[e].type)return void i[e].getAsString((i=>t(Bt(i))));if("application/x-moz-file-promise-url"===i[e].type)return void i[e].getAsString((t=>{}));if("string"===i[e].kind){let t=i[e].type;i[e].getAsString((i=>console.log(t,i)))}}return e("No compatible drop type found")}))};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
