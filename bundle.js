 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Bt(t){const i=(new DOMParser).parseFromString(t,"text/html").querySelector("img")?.src;return i??null}const Ht=()=>([1e7]+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,(t=>(t^crypto.getRandomValues(new Uint8Array(1))[0]&15>>t/4).toString(16))),Wt=t=>new CustomEvent("game-event",{detail:t});class Zt{constructor(){this.order=[],this.map=new Map}get(t){const i=this.map.get(t);if(void 0!==i)return this.order[i]}has(t){return this.map.has(t)}add(t,i){this.map.set(t,this.order.length),this.order.push(i)}delete(t){const i=this.map.get(t);return void 0!==i&&(this.order.splice(i,1),this.map.delete(t),!0)}index(t){return this.map.get(t)}set_index(t,i){const e=this.map.get(t);if(void 0===e||i>=this.order.length)return!1;const s=this.order.splice(e,1)[0];return this.order.splice(i,0,s),this.map.forEach(((t,e)=>{t>=i&&this.map.set(e,t+1)})),this.map.set(t,i),!0}values(){return this.order}get size(){return this.map.size}}let Gt=class extends it{constructor(){super(),this.width=30,this.height=40,this.tokens=new Zt,this.#g=0,this.#f=t=>{bt(t),this.#g++},this.#w=t=>{bt(t);const i=this.#b(t).map(Vt),e=xt($t([this.width,this.height],-1),72);this._drop_hint=Tt([0,0],e,i),this.hovering="canvas"},this.#m=t=>{--this.#g<=0&&(this._drop_hint=void 0,this.hovering=void 0)},this.#y=t=>{bt(t),this._drop_hint=void 0,this.hovering="bg"},this.#$=async t=>{bt(t);try{const i=await Jt(t);this.dispatchEvent(mt("bg-drop",i))}catch(t){}this.hovering=void 0},this.#k=async t=>{bt(t);try{const i=await Jt(t);this.dispatchEvent(mt("token-drop",{loc:this._drop_hint,dim:[72,72],img:i}))}catch(t){}this._drop_hint=void 0,this.hovering=void 0},this.#x=t=>{t.preventDefault(),t.stopPropagation(),this.dispatchEvent(mt("token-select",t.target.id))},this.#_=t=>{this.dispatchEvent(mt("token-select",void 0))},this.#S=t=>{ft(t)&&(bt(t),t.target.setPointerCapture(t.pointerId),this.#C=this.#b(t))},this.#M={move:[0,0],resize:[0,0],r:0},this.#A=t=>{if(!ft(t))return;this.#C||this.#S(t),bt(t);const i=Tt([0,0],this.#T,this.#b(t)),e=this.tokens.get(this.selection),s=e.dim,o=e.loc,n=t.target.classList;let r=[0,0],h=[0,0],l=0;if(n.contains("rn")&&(h[1]=o[1]-Kt(i[1]),r[1]=Kt(i[1])-o[1]),n.contains("rw")&&(h[0]=o[0]-Kt(i[0]),r[0]=Kt(i[0])-o[0]),n.contains("rs")&&(h[1]=Kt(i[1])-s[1]-o[1]),n.contains("re")&&(h[0]=Kt(i[0])-s[0]-o[0]),n.contains("ro")){const t=yt(o,Ct(s,2)),n=kt(i,t),r=180*Math.atan2(n[0],-n[1])/Math.PI;l=90*Math.round(r/90)-e.r%360}n.contains("selection-box")?r=kt(i,this.#C).map(Kt):(r=At($t(s,-72),r),h=Mt($t(xt(s,-1),72),h)),l===this.#M.r&&Et(r,this.#M.move)&&Et(h,this.#M.resize)||(this.#C=yt(this.#C,r),this.#M={move:[0,0],resize:[0,0],r:0},this.dispatchEvent(Wt({type:"token-manipulated",id:e.id,loc:yt(e.loc,r),dim:yt(e.dim,h),r:e.r+l})))},this.#E=t=>{bt(t),this.#C=void 0},this.#b=t=>kt(this.viewport.coordToLocal([t.clientX,t.clientY]),[60,60]),this.#o=t=>{if(!this.selection)return;if(8===t.keyCode)return this.dispatchEvent(Wt({type:"token-removed",id:this.selection})),void bt(t);let i=this.tokens.get(this.selection);let e={ArrowUp:[0,-72],ArrowDown:[0,72],ArrowLeft:[-72,0],ArrowRight:[72,0]}[t.key];e&&(i.loc=Tt([0,0],kt(this.#T,i.dim),yt(i.loc,e)),this.dispatchEvent(Wt({type:"token-manipulated",id:i.id,loc:i.loc,dim:i.dim,r:i.r})),bt(t))}}get#T(){return xt([this.width,this.height],72)}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.#o)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this.#o)}render(){let[t,i]=this.#T,e=this.tokens.get(this.selection);return O`
      <bg-viewport
        @pointerup=${this.#_}
        @dragstart=${bt}
        @dragenter=${this.#f}
    ...
    `}createRenderRoot(){return super.createRenderRoot()}#g;#f;#w;#m;#y;#$;#k;#x;#_;#C;#S;#M;#A;#E;#b;#o};Gt.styles=n`
    :host {
      position: relative;
      display: block;
