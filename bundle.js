 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
var g;p.finalized=!0,p.elementProperties=new Map,p.elementStyles=[],p.shadowRootOptions={mode:"open"},null==c||c({ReactiveElement:p}),(null!==(h=globalThis.reactiveElementVersions)&&void 0!==h?h:globalThis.reactiveElementVersions=[]).push("1.2.1");const f=globalThis.trustedTypes,w=f?f.createPolicy("lit-html",{createHTML:t=>t}):void 0,b=`lit$${(Math.random()+"").slice(9)}$`,m="?"+b,y=`<${m}>`,$=document,k=(t="")=>$.createComment(t),_=t=>null===t||"object"!=typeof t&&"function"!=typeof t,x=Array.isArray,S=t=>{var i;return x(t)||"function"==typeof(null===(i=t)||void 0===i?void 0:i[Symbol.iterator])},C=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,M=/-->/g,A=/>/g,T=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,E=/'/g,R=/"/g,U=/^(?:script|style|textarea)$/i,z=t=>(i,...e)=>({_$litType$:t,strings:i,values:e}),O=z(1),N=z(2),P=Symbol.for("lit-noChange"),j=Symbol.for("lit-nothing"),L=new WeakMap,D=$.createTreeWalker($,129,null,!1),I=(t,i)=>{const e=t.length-1,s=[];let o,n=2===i?"<svg>":"",r=C;for(let i=0;i<e;i++){const e=t[i];let h,l,a=-1,c=0;for(;c<e.length&&(r.lastIndex=c,l=r.exec(e),null!==l);)c=r.lastIndex,r===C?"!--"===l[1]?r=M:void 0!==l[1]?r=A:void 0!==l[2]?(U.test(l[2])&&(o=RegExp("</"+l[2],"g")),r=T):void 0!==l[3]&&(r=T):r===T?">"===l[0]?(r=null!=o?o:C,a=-1):void 0===l[1]?a=-2:(a=r.lastIndex-l[2].length,h=l[1],r=void 0===l[3]?T:'"'===l[3]?R:E):r===R||r===E?r=T:r===M||r===A?r=C:(r=T,o=void 0);const d=r===T&&t[i+1].startsWith("/>")?" ":"";n+=r===C?e+y:a>=0?(s.push(h),e.slice(0,a)+"$lit$"+e.slice(a)+b+d):e+b+(-2===a?(s.push(void 0),i):d)}const h=n+(t[e]||"<?>")+(2===i?"</svg>":"");if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return[void 0!==w?w.createHTML(h):h,s]};class B{constructor({strings:t,_$litType$:i},e){let s;this.parts=[];let o=0,n=0;const r=t.length-1,h=this.parts,[l,a]=I(t,i);if(this.el=B.createElement(l,e),D.currentNode=this.el.content,2===i){const t=this.el.content,i=t.firstChild;i.remove(),t.append(...i.childNodes)}for(;null!==(s=D.nextNode())&&h.length<r;){if(1===s.nodeType){if(s.hasAttributes()){const t=[];for(const i of s.getAttributeNames())if(i.endsWith("$lit$")||i.startsWith(b)){const e=a[n++];if(t.push(i),void 0!==e){const t=s.getAttribute(e.toLowerCase()+"$lit$").split(b),i=/([.?@])?(.*)/.exec(e);h.push({type:1,index:o,name:i[2],strings:t,ctor:"."===i[1]?G:"?"===i[1]?V:"@"===i[1]?q:Z})}else h.push({type:6,index:o})}for(const i of t)s.removeAttribute(i)}if(U.test(s.tagName)){const t=s.textContent.split(b),i=t.length-1;if(i>0){s.textContent=f?f.emptyScript:"";for(let e=0;e<i;e++)s.append(t[e],k()),D.nextNode(),h.push({type:2,index:++o});s.append(t[i],k())}}}else if(8===s.nodeType)if(s.data===m)h.push({type:2,index:o});else{let t=-1;for(;-1!==(t=s.data.indexOf(b,t+1));)h.push({type:7,index:o}),t+=b.length-1}o++}}static createElement(t,i){const e=$.createElement("template");return e.innerHTML=t,e}}function J(t,i,e=t,s){var o,n,r,h;if(i===P)return i;let l=void 0!==s?null===(o=e._$Cl)||void 0===o?void 0:o[s]:e._$Cu;const a=_(i)?void 0:i._$litDirective$;return(null==l?void 0:l.constructor)!==a&&(null===(n=null==l?void 0:l._$AO)||void 0===n||n.call(l,!1),void 0===a?l=void 0:(l=new a(t),l._$AT(t,e,s)),void 0!==s?(null!==(r=(h=e)._$Cl)&&void 0!==r?r:h._$Cl=[])[s]=l:e._$Cu=l),void 0!==l&&(i=J(t,l._$AS(t,i.values),l,s)),i}class H{constructor(t,i){this.v=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(t){var i;const{el:{content:e},parts:s}=this._$AD,o=(null!==(i=null==t?void 0:t.creationScope)&&void 0!==i?i:$).importNode(e,!0);D.currentNode=o;let n=D.nextNode(),r=0,h=0,l=s[0];for(;void 0!==l;){if(r===l.index){let i;2===l.type?i=new W(n,n.nextSibling,this,t):1===l.type?i=new l.ctor(n,l.name,l.strings,this,t):6===l.type&&(i=new F(n,this,t)),this.v.push(i),l=s[++h]}r!==(null==l?void 0:l.index)&&(n=D.nextNode(),r++)}return o}m(t){let i=0;for(const e of this.v)void 0!==e&&(void 0!==e.strings?(e._$AI(t,e,i),i+=e.strings.length-2):e._$AI(t[i])),i++}}class W{constructor(t,i,e,s){var o;this.type=2,this._$AH=j,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=e,this.options=s,this._$Cg=null===(o=null==s?void 0:s.isConnected)||void 0===o||o}get _$AU(){var t,i;return null!==(i=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==i?i:this._$Cg}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===t.nodeType&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=J(this,t,i),_(t)?t===j||null==t||""===t?(this._$AH!==j&&this._$AR(),this._$AH=j):t!==this._$AH&&t!==P&&this.$(t):void 0!==t._$litType$?this.T(t):void 0!==t.nodeType?this.S(t):S(t)?this.A(t):this.$(t)}M(t,i=this._$AB){return this._$AA.parentNode.insertBefore(t,i)}S(t){this._$AH!==t&&(this._$AR(),this._$AH=this.M(t))}$(t){this._$AH!==j&&_(this._$AH)?this._$AA.nextSibling.data=t:this.S($.createTextNode(t)),this._$AH=t}T(t){var i;const{values:e,_$litType$:s}=t,o="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=B.createElement(s.h,this.options)),s);if((null===(i=this._$AH)||void 0===i?void 0:i._$AD)===o)this._$AH.m(e);else{const t=new H(o,this),i=t.p(this.options);t.m(e),this.S(i),this._$AH=t}}_$AC(t){let i=L.get(t.strings);return void 0===i&&L.set(t.strings,i=new B(t)),i}A(t){x(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let e,s=0;for(const o of t)s===i.length?i.push(e=new W(this.M(k()),this.M(k()),this,this.options)):e=i[s],e._$AI(o),s++;s<i.length&&(this._$AR(e&&e._$AB.nextSibling,s),i.length=s)}_$AR(t=this._$AA.nextSibling,i){var e;for(null===(e=this._$AP)||void 0===e||e.call(this,!1,!0,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i}}setConnected(t){var i;void 0===this._$AM&&(this._$Cg=t,null===(i=this._$AP)||void 0===i||i.call(this,t))}}class Z{constructor(t,i,e,s,o){this.type=1,this._$AH=j,this._$AN=void 0,this.element=t,this.name=i,this._$AM=s,this.options=o,e.length>2||""!==e[0]||""!==e[1]?(this._$AH=Array(e.length-1).fill(new String),this.strings=e):this._$AH=j}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,i=this,e,s){const o=this.strings;let n=!1;if(void 0===o)t=J(this,t,i,0),n=!_(t)||t!==this._$AH&&t!==P,n&&(this._$AH=t);else{const s=t;let r,h;for(t=o[0],r=0;r<o.length-1;r++)h=J(this,s[e+r],i,r),h===P&&(h=this._$AH[r]),n||(n=!_(h)||h!==this._$AH[r]),h===j?t=j:t!==j&&(t+=(null!=h?h:"")+o[r+1]),this._$AH[r]=h}n&&!s&&this.k(t)}k(t){t===j?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class G extends Z{constructor(){super(...arguments),this.type=3}k(t){this.element[this.name]=t===j?void 0:t}}const K=f?f.emptyScript:"";class V extends Z{constructor(){super(...arguments),this.type=4}k(t){t&&t!==j?this.element.setAttribute(this.name,K):this.element.removeAttribute(this.name)}}class q extends Z{constructor(t,i,e,s,o){super(t,i,e,s,o),this.type=5}_$AI(t,i=this){var e;if((t=null!==(e=J(this,t,i,0))&&void 0!==e?e:j)===P)return;const s=this._$AH,o=t===j&&s!==j||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,n=t!==j&&(s===j||o);o&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var i,e;"function"==typeof this._$AH?this._$AH.call(null!==(e=null===(i=this.options)||void 0===i?void 0:i.host)&&void 0!==e?e:this.element,t):this._$AH.handleEvent(t)}}class F{constructor(t,i,e){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=e}get _$AU(){return this._$AM._$AU}_$AI(t){J(this,t)}}const Y={P:"$lit$",V:b,L:m,I:1,N:I,R:H,D:S,j:J,H:W,O:Z,F:V,B:q,W:G,Z:F},Q=window.litHtmlPolyfillSupport;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */function Jt(t){const i=(new DOMParser).parseFromString(t,"text/html").querySelector("img")?.src;return i??null}const Ht=()=>([1e7]+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,(t=>(t^crypto.getRandomValues(new Uint8Array(1))[0]&15>>t/4).toString(16))),Wt=t=>new CustomEvent("game-event",{detail:t});class Zt{constructor(){this.order=[],this.map=new Map}get(t){const i=this.map.get(t);if(void 0!==i)return this.order[i]}has(t){return this.map.has(t)}add(t,i){this.map.set(t,this.order.length),this.order.push(i)}delete(t){const i=this.map.get(t);return void 0!==i&&(this.order.splice(i,1),this.map.delete(t),!0)}index(t){return this.map.get(t)}set_index(t,i){const e=this.map.get(t);if(void 0===e||i>=this.order.length)return!1;const s=this.order.splice(e,1)[0];return this.order.splice(i,0,s),this.map.forEach(((t,e)=>{t>=i&&this.map.set(e,t+1)})),this.map.set(t,i),!0}values(){return this.order}get size(){return this.map.size}}let Gt=class extends it{constructor(){super(),this.width=30,this.height=40,this.tokens=new Zt,this.#g=0,this.#f=t=>{bt(t),this.#g++},this.#w=t=>{bt(t);const i=this.#b(t).map(Vt),e=_t($t([this.width,this.height],-1),72);this._drop_hint=Tt([0,0],e,i),this.hovering="canvas"},this.#m=t=>{--this.#g<=0&&(this._drop_hint=void 0,this.hovering=void 0)},this.#y=t=>{bt(t),this._drop_hint=void 0,this.hovering="bg"},this.#$=async t=>{bt(t);try{const i=await Bt(t);this.dispatchEvent(mt("bg-drop",i))}catch(t){}this.hovering=void 0},this.#k=async t=>{bt(t);try{const i=await Bt(t);this.dispatchEvent(mt("token-drop",{loc:this._drop_hint,dim:[72,72],img:i}))}catch(t){}this._drop_hint=void 0,this.hovering=void 0},this.#_=t=>{t.preventDefault(),t.stopPropagation(),this.dispatchEvent(mt("token-select",t.target.id))},this.#x=t=>{this.dispatchEvent(mt("token-select",void 0))},this.#S=t=>{ft(t)&&(bt(t),t.target.setPointerCapture(t.pointerId),this.#C=this.#b(t))},this.#M={move:[0,0],resize:[0,0],r:0},this.#A=t=>{if(!ft(t))return;this.#C||this.#S(t),bt(t);const i=Tt([0,0],this.#T,this.#b(t)),e=this.tokens.get(this.selection),s=e.dim,o=e.loc,n=t.target.classList;let r=[0,0],h=[0,0],l=0;if(n.contains("rn")&&(h[1]=o[1]-Kt(i[1]),r[1]=Kt(i[1])-o[1]),n.contains("rw")&&(h[0]=o[0]-Kt(i[0]),r[0]=Kt(i[0])-o[0]),n.contains("rs")&&(h[1]=Kt(i[1])-s[1]-o[1]),n.contains("re")&&(h[0]=Kt(i[0])-s[0]-o[0]),n.contains("ro")){const t=yt(o,Ct(s,2)),n=kt(i,t),r=180*Math.atan2(n[0],-n[1])/Math.PI;l=90*Math.round(r/90)-e.r%360}n.contains("selection-box")?r=kt(i,this.#C).map(Kt):(r=At($t(s,-72),r),h=Mt($t(_t(s,-1),72),h)),l===this.#M.r&&Et(r,this.#M.move)&&Et(h,this.#M.resize)||(this.#C=yt(this.#C,r),this.#M={move:[0,0],resize:[0,0],r:0},this.dispatchEvent(Wt({type:"token-manipulated",id:e.id,loc:yt(e.loc,r),dim:yt(e.dim,h),r:e.r+l})))},this.#E=t=>{bt(t),this.#C=void 0},this.#b=t=>kt(this.viewport.coordToLocal([t.clientX,t.clientY]),[60,60]),this.#o=t=>{if(!this.selection)return;if(8===t.keyCode)return this.dispatchEvent(Wt({type:"token-removed",id:this.selection})),void bt(t);let i=this.tokens.get(this.selection);let e={ArrowUp:[0,-72],ArrowDown:[0,72],ArrowLeft:[-72,0],ArrowRight:[72,0]}[t.key];e&&(i.loc=Tt([0,0],kt(this.#T,i.dim),yt(i.loc,e)),this.dispatchEvent(Wt({type:"token-manipulated",id:i.id,loc:i.loc,dim:i.dim,r:i.r})),bt(t))}}get#T(){return _t([this.width,this.height],72)}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.#o)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this.#o)}render(){let[t,i]=this.#T,e=this.tokens.get(this.selection);return O`
        ...
        <svg id="root" width=${t+120} height=${i+120}>
          ...
          <svg x=${60} y=${60} width=${t} height=${i} id="surface">
            ...
            <svg clip-path="url(#canvasClip)">
              ...
              ${It(this.tokens.values(),(t=>t.id),((t,i)=>{const e=this.resources?.get(t.res),[s,o]=$t(t.dim,-1.5),[n,r]=$t(t.loc,.75);return O`
                    <svg
                      viewBox="0 0 1 1"
                      x=${n}
                      y=${r}
    ...
    `}createRenderRoot(){return super.createRenderRoot()}#g;#f;#w;#m;#y;#$;#k;#_;#x;#C;#S;#M;#A;#E;#b;#o};Gt.styles=n`
    :host {
      position: relative;
      display: block;
  ...
  `,t([nt({type:Number})],Gt.prototype,"width",void 0),t([nt({type:Number})],Gt.prototype,"height",void 0),t([nt()],Gt.prototype,"bg",void 0),t([nt({attribute:!1})],Gt.prototype,"tokens",void 0),t([nt({attribute:!1})],Gt.prototype,"resources",void 0),t([nt()],Gt.prototype,"selection",void 0),t([at("root",!0)],Gt.prototype,"root",void 0),t([at("bg-viewport",!0)],Gt.prototype,"viewport",void 0),t([rt()],Gt.prototype,"_drop_hint",void 0),t([rt()],Gt.prototype,"hovering",void 0),Gt=t([st("bg-canvas")],Gt);const Kt=t=>72*Math.round(t/72),Vt=t=>t-t%72,qt={iceServers:[{urls:"stun:stun.l.google.com:19302"}]};class Ft{constructor(t){this.#R=()=>{},this.#U=new RTCPeerConnection(qt),this.#z=!1,this.#R=t,this.#O()}#R;#U;#z;async initiate(){this.#z=!0;let t=await this.#U.createOffer();await this.#U.setLocalDescription(t),this.#R({type:"offer",offer:t})}#O(){null!==this.#U.localDescription&&(this.#U.onicecandidate=null,this.#U.onconnectionstatechange=null,this.#U.close()),this.#U=new RTCPeerConnection(qt),this.data=this.#U.createDataChannel("data",{ordered:!0,negotiated:!0,id:1}),this.events=this.#U.createDataChannel("control",{ordered:!0,negotiated:!0,id:2}),this.#U.onicecandidate=({candidate:t})=>{null!==t&&this.#R({type:"icecandidate",candidate:t})},this.#U.onconnectionstatechange=()=>{"closed"===this.#U.connectionState&&(this.#O(),this.#z&&this.initiate())}}async signal(t){console.log("received",t);let i=this.#U.signalingState;switch(t.type){case"offer":if("stable"!==i)return void console.error(`Received offer at incorrect state: ${i}. Ignoring.`);this.#U.setRemoteDescription(new RTCSessionDescription(t.offer));const e=await this.#U.createAnswer();await this.#U.setLocalDescription(e),this.#R({type:"answer",answer:e});break;case"answer":if("have-local-offer"!==i)return void console.error(`Received answer at incorrect state: ${i}. Ignoring.`);this.#U.setRemoteDescription(new RTCSessionDescription(t.answer));break;case"icecandidate":await this.#U.addIceCandidate(t.candidate)}}}class Yt extends EventTarget{constructor(t,i){super(),this.#N=!1,this.#P="connected",this.#j=new Map,this.#L=t,this.#D=i}#L;#D;#N;#P;#j;get ident(){return this.#L}get status(){return this.#P}static async establish(t,i){i&&(t.pathname="/"+i);let e=await this.#I(t);return console.log("acquired socket for ",i),new Promise(((t,i)=>{e.addEventListener("message",(s=>{let o=JSON.parse(s.data);e.removeEventListener("close",i);let n=new Yt(o.id,e);n.#B(),t(n)}),{once:!0}),e.addEventListener("close",i)}))}static async#I(t){return new Promise(((i,e)=>{let s=new WebSocket(t.toString());s.addEventListener("close",(t=>e(t)),{once:!0}),s.addEventListener("open",(()=>{console.log("WS CONNECTED"),s.removeEventListener("close",e),i(s)}))}))}#B(){let t=new URL(this.#D.url);this.#D.addEventListener("error",(t=>{this.dispatchEvent(new CustomEvent("error",{detail:t}))})),this.#D.addEventListener("close",(()=>this.#J(t))),this.#D.addEventListener("message",(t=>{let i=JSON.parse(t.data);this.#H(i)}))}async connect_to(t){let i=new Ft((i=>{this.#D.send(JSON.stringify({target:t,...i})),"shutdown"===i.type&&this.#j.delete(i.from)}));return this.#j.set(t,i),await i.initiate(),i}#W(t){this.#P=t,this.dispatchEvent(new CustomEvent("status",{detail:t}))}async#J(t){let i;if(t.pathname="/"+this.#L,this.#N)this.#W("closed");else{this.#W("disconnected");try{i=await Yt.#I(t)}catch(t){return console.error("Error reconnecting",t),void setTimeout((()=>this.#J),1e3)}this.#D=i,this.#B(),this.#W("connected")}}_disconnect(){this.#D.close()}close(){this.#N=!0,this.#D.close()}#H(t){if(console.log(t),t.error)this.dispatchEvent(new CustomEvent("error",{detail:t.error}));else if("offer"!==t.type||this.#j.has(t.from))this.#j.get(t.from)?.signal(t),"shutdown"===t.type&&this.#j.delete(t.from);else{let i=new Ft((i=>{this.#D.send(JSON.stringify({target:t.from,...i})),"shutdown"===t.type&&this.#j.delete(t.from)}));this.#j.set(t.from,i),i.signal(t),this.dispatchEvent(new CustomEvent("peer",{detail:i}))}}}const Qt=t=>{let i=(t=>new ReadableStream({start(i){t.onmessage=({data:t})=>i.enqueue(t);const e=()=>{i.close(),t.removeEventListener("close",e)};t.addEventListener("close",e)},cancel(){t.close()}}))(t).pipeThrough((()=>{let t,i=[];return new TransformStream({start(){},async transform(e,s){if("string"==typeof e){let i=JSON.parse(e);if("event"===i.type)return void s.enqueue(i.event);t=i}else{if(!t)return;if(i.push(e),0==--t.chunks)return s.enqueue({type:"file",res_name:t.res_name,contents:new Blob(i)}),void(i=[])}},flush(){i=[]}})})()),e=new TransformStream({start(){},async transform(t,i){if("file"===t.type){i.enqueue(JSON.stringify({type:"file",res_name:t.res_name,chunks:Math.ceil(t.contents.size/64e3)}));for(let e=0;e<t.contents.size;e+=64e3)i.enqueue(await t.contents.slice(e,Math.min(e+64e3,t.contents.size)).arrayBuffer())}else i.enqueue(JSON.stringify({type:"event",event:t}))}});return e.readable.pipeTo((t=>{let i;return new WritableStream({start(e){const s=()=>{e.error("Closed"),t.removeEventListener("close",s)};t.addEventListener("close",s),t.onopen=()=>i&&i(),t.onbufferedamountlow=()=>i&&i()},async write(e){("connecting"===t.readyState||t.bufferedAmount>t.bufferedAmountLowThreshold)&&await new Promise(((t,e)=>i=t)),t.send(e)},abort(){t.close()}},new CountQueuingStrategy({highWaterMark:1}))})(t)),{writable:e.writable,readable:i}};class Xt{constructor(t){this.server=this,this.#Z=new Set,this.#G=new Set,this.on_event=()=>{},this.signaler=t;let{readable:i,writable:e}=new TransformStream({start(){},transform(t,i){console.log("TF STREAM"),i.enqueue(t)},flush(){}}),s=i.getReader(),o=e.getWriter();this.signaler.addEventListener("peer",(async({detail:t})=>{let i=Qt(t.events),e=Qt(t.data);const s=i.writable.getWriter(),n=e.writable.getWriter();this.#Z.add(s),this.#G.add(n),console.log("Getting state"),this.get_state&&(console.log("state",this.get_state()),s.write(this.get_state())),console.log("writing images");for(const[t,i]of this.get_images?this.get_images():[])console.log(t,i),n.write({type:"file",res_name:t,contents:await(await fetch(i)).blob()});(async()=>{let t,e,n=i.readable.getReader();for(;({value:t,done:e}=await n.read())&&!e;)await o.write({author:s,ev:t});this.#Z.delete(s)})(),(async()=>{let t,i,r=e.readable.getReader();for(;({value:t,done:i}=await r.read())&&!i;)await o.write({author:s,ev:t});this.#G.delete(n)})()})),(async()=>{let t,i,e;for(;({value:{author:e,ev:t},done:i}=await s.read())&&!i;)await this.send_event(t,e),this.on_event(t)})()}get status(){return"connected"===this.signaler.status?"connected":"disconnected"}#Z;#G;async send_event(t,i){let e="file"===t.type?this.#G:this.#Z;await Promise.all(Array.from(e).filter((t=>t!==i)).map((i=>i.write(t))))}static async establish(){return new Xt(await Yt.establish(new URL("wss://battlegrid-signaling.herokuapp.com/")))}}class ti{constructor(t){this.status="disconnected",this.server=void 0,this.on_event=t=>{},this.on_status=()=>{},this.#K=t}#V;#q;#K;#W(t){this.status=t,setTimeout(this.on_status,0)}async connect(){let t;this.#W("connecting");try{let i=await Yt.establish(new URL("wss://battlegrid-signaling.herokuapp.com"));t=await new Promise((async(t,e)=>{i.addEventListener("error",e,{once:!0});let s=await i.connect_to(this.#K);s.data.onopen=()=>t(s)}))}catch(t){return console.log("error"),void this.#W("error")}let i=Qt(t.events);this.#V=i.writable.getWriter();let e=i.readable.getReader(),s=Qt(t.data);this.#q=s.writable.getWriter();let o=s.readable.getReader();this.#W("connected"),(async()=>{let t,i;for(;({value:t,done:i}=await o.read())&&!i;)console.log("DATA",t),this.on_event(t);console.log("dccccc"),this.#W("disconnected")})(),(async()=>{let t,i;for(;({value:t,done:i}=await e.read())&&!i;)console.log("EVENT!",t),this.on_event(t);console.log("dccccc"),this.#W("disconnected")})()}async send_event(t){("file"===t.type?this.#q:this.#V)?.write(t)}}let ii=class extends it{constructor(){super(...arguments),this._state=!1,this._loaded=!1,this._buy=t=>{console.log("CLICK"),bt(t),this._state=!0,document.addEventListener("click",this.#F,{capture:!0})},this.#F=t=>{bt(t),this._state=!1,document.removeEventListener("click",this.#F,{capture:!0})},this.#Y=t=>{this._loaded=!0}}render(){return O`<button @click="${this._buy}">Buy Me A Coffee</button> ${this._state?O`<div id="container"><iframe class="${this._loaded?"loaded":""}" allow="payment" src="https://ko-fi.com/djrenren/?hidefeed=true&widget=true&embed=true&preview=true" title="djrenren" @load="${this.#Y}"></iframe></div>`:null}`}#F;#Y};ii.styles=n`:host{display:block;position:relative}iframe{border:none;display:block;opacity:0;width:100%;height:100%;transition:opacity .5s linear}#container{border-radius:5px;box-shadow:0 0 6px rgba(0,0,0,.7);position:absolute;width:350px;height:525px;bottom:-535px;right:0;animation-name:fade;animation-duration:.5s;animation-direction:backwards;background:url(assets/loading.svg) center/100px no-repeat,#ededf0;overflow:hidden}iframe.loaded{opacity:1}@keyframes fade{0%{opacity:0}100%{opacity:1}}`,t([rt()],ii.prototype,"_state",void 0),t([rt()],ii.prototype,"_loaded",void 0),ii=t([st("buy-me-a-coffee")],ii);class ei{constructor(){this.index=new Set}get(t){return t.startsWith("local:")?window.sessionStorage.getItem(t):t}delete(t){const i=this.get(t);return!!i&&(URL.revokeObjectURL(i),window.sessionStorage.removeItem(t),!0)}register(t,i){if("string"==typeof t)return t;let e=i??"local:"+Ht();return this.index.add(e),window.sessionStorage.setItem(e,URL.createObjectURL(t)),e}*all(){for(let t of this.index.values())yield[t,this.get(t)]}}class si extends EventTarget{constructor(){super(...arguments),this.tokens=new Zt,this.grid_dim=[30,20],this.resources=new ei,this.get_state=()=>({type:"state-sync",tokens:[...this.tokens.values()],grid_dim:this.grid_dim,bg:this.#Q})}#Q;get bg(){return this.#Q?this.resources.get(this.#Q):null}set_bg(t){const i=t?this.resources.register(t):void 0;this.apply({type:"bg",res:i}),t instanceof Blob&&this.dispatchEvent(Wt({type:"file",res_name:i,contents:t}))}add_token(t,i){const e=Ht(),s=this.resources.register(t),o={id:e,res:s,...i};this.apply({type:"token-added",...o}),t instanceof Blob&&this.dispatchEvent(Wt({type:"file",res_name:s,contents:t}))}local_apply(t){switch(console.log("APPLYING!"),t.type){case"token-manipulated":let i=this.tokens.get(t.id);if(!i)return void console.error("Update received for nonexistant token",t.id);Object.assign(i,{dim:t.dim,loc:t.loc,r:t.r});break;case"token-added":let e={id:t.id,dim:t.dim,loc:t.loc,res:t.res,r:0};this.tokens.add(t.id,e);break;case"grid-resized":this.grid_dim=t.dim;break;case"token-removed":const s=this.tokens.get(t.id);if(!s)return void console.error("Tried to remove nonexistant token",t.id);this.resources.delete(s.res),this.tokens.delete(s.id);break;case"state-sync":console.log("applying #tokens",t.tokens),this.tokens=new Zt;for(const i of t.tokens)this.tokens.add(i.id,i);this.grid_dim=t.grid_dim,this.#Q=t.bg;break;case"token-reorder":const o=this.tokens.index(t.id);if(void 0===o)return void console.error("Tried to reorder non-existant token",t.id);let n;n="top"===t.idx?this.tokens.size-1:"bottom"===t.idx?0:"up"===t.idx?Math.min(this.tokens.size-1,o+1):Math.max(0,o-1),this.tokens.set_index(t.id,n);break;case"file":this.resources.register(t.contents,t.res_name);break;case"bg":this.#Q&&this.resources.delete(this.#Q),this.#Q=t.res}this.dispatchEvent(new CustomEvent("updated"))}remove_token(t){this.apply({type:"token-removed",id:t})}apply(t){this.local_apply(t),this.dispatchEvent(new CustomEvent("game-event",{detail:t}))}set_dim(t){this.apply({type:"grid-resized",dim:t})}}
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const oi=t=>null!=t?t:j;let ni=class extends it{constructor(){super(...arguments),this.host_pending=!1,this.#X=new si,this.#tt=()=>{this.#X.set_dim(Mt([1,1],[parseInt(this.width?.value)??0,parseInt(this.height?.value)??0]))},this.#it=()=>{this.client&&!this.client.server&&this.client.connect()},this.#et=()=>{this.client=void 0,window.history.pushState(null,"",window.location.href.split("?")[0])},this.#st=async()=>{try{this.host_pending=!0;let t=await Xt.establish();this.host_pending=!1,this.client=t,t.on_event=this.#ot,t.get_state=this.#X.get_state,t.get_images=()=>this.#X.resources.all(),window.history.pushState({},"","?game="+t.signaler.ident),navigator.clipboard.writeText(window.location.toString())}catch(t){console.error(t)}},this.#ot=t=>{this.#X.local_apply(t)},this.#nt=t=>{this.client?.send_event(t.detail)}}#X;render(){let t="error"===this.client?.status?O`<div class="message error"><div><h1>Error connecting to remote grid</h1><button @click="${this.#it}">Try again</button> <button @click="${this.#et}">New local grid</button></div></div>`:null,i="connecting"===this.client?.status?O`<div class="message"><div><h1>Connecting to grid...</h1></div></div>`:null,e="disconnected"===this.client?.status?O`<div class="message"><div><h1>Disconnected from host</h1><button @click="${this.#it}">Try again</button> <button @click="${this.#et}">Continue locally</button></div></div>`:null,s=t||i||e;return O`<section id="toolbar" class="group"><div class="group"><span>Grid: <input id="width" type="number" min="1" @input="${this.#tt}" .value="${this.#X.grid_dim[0]+""}"> x <input id="height" type="number" min="1" @input="${this.#tt}" .value="${this.#X.grid_dim[1]+""}"> </span>${this.selection?O`<div><button @click="${()=>this.#X.apply({type:"token-reorder",id:this.selection.id,idx:"down"})}" ?disabled="${0===this.#X.tokens.index(this.selection.id)}">Move Down</button> <button @click="${()=>this.#X.apply({type:"token-reorder",id:this.selection.id,idx:"up"})}" ?disabled="${this.#X.tokens.index(this.selection.id)===this.#X.tokens.size-1}">Move Up</button></div>`:null}</div><div class="group">${this.host_pending?O`<img src="assets/loading.svg">`:this.client?O`<div>${this.client.server?"hosting":this.client.status}</div>`:O`<button @click="${this.#st}">Host</button>`}<buy-me-a-coffee class="right"></buy-me-a-coffee></div></section><bg-canvas bg="${oi(this.#X.bg??void 0)}" selection="${oi(this.selection?.id)}" width="${this.#X.grid_dim[0]}" height="${this.#X.grid_dim[1]}" .tokens="${this.#X.tokens}" .resources="${this.#X.resources}" @token-drop="${({detail:t})=>this.#X.add_token(t.img,{loc:t.loc,r:0,dim:t.dim})}" @bg-drop="${({detail:t})=>this.#X.set_bg(t)}" @token-select="${({detail:t})=>{this.selection=t?this.#X.tokens.get(t):void 0}}" @game-event="${({detail:t})=>this.#X.apply(t)}"></bg-canvas>${s}`}updated(t){t.has("client")&&(document.title="BattleGrid"+(this.client&&"connected"===this.client.status?this.client.server?"- Hosting":"- Connected":""))}#tt;async connectedCallback(){super.connectedCallback(),this.#X.addEventListener("game-event",this.#nt),this.#X.addEventListener("updated",(()=>{this.selection&&!this.#X.tokens.has(this.selection.id)&&(this.selection=void 0),this.requestUpdate(),this.canvas?.requestUpdate()}));let t=new URLSearchParams(window.location.search).get("game");if(!t)return{};let i=new ti(t);i.on_event=this.#ot,i.on_status=()=>this.requestUpdate("client"),this.client=i,await i.connect()}#it;#et;#st;#ot;#nt};ni.styles=n`:host{width:100%;height:100%;display:grid;grid:"toolbar" 30px "viewport" 1fr/1fr;font-family:inherit;--ui-bg:#f9f9fa}.message{grid-area:1/1/3/1;display:grid;align-items:center;justify-items:center;background:#fff;z-index:2}.right{justify-self:end}bg-canvas{grid-area:viewport;z-index:1}input[type=number]{width:3em}.group{display:flex;align-items:center;height:100%;flex-wrap:nowrap}#toolbar{grid-area:toolbar;box-shadow:0 0 4px gray;z-index:2;background:var(--ui-bg);justify-content:space-between;padding:0 1em;grid-template-rows:unset}.group img{width:1em;height:1em;object-fit:cover;display:inline-block}`,t([at("#width",!0)],ni.prototype,"width",void 0),t([at("#height",!0)],ni.prototype,"height",void 0),t([at("bg-canvas",!0)],ni.prototype,"canvas",void 0),t([rt()],ni.prototype,"client",void 0),t([rt()],ni.prototype,"selection",void 0),t([rt()],ni.prototype,"host_pending",void 0),ni=t([st("bg-app")],ni),document.body.addEventListener("wheel",(t=>{console.log("HUH..."),t.ctrlKey&&t.preventDefault()}),{passive:!1});
