 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
var g;p.finalized=!0,p.elementProperties=new Map,p.elementStyles=[],p.shadowRootOptions={mode:"open"},null==c||c({ReactiveElement:p}),(null!==(h=globalThis.reactiveElementVersions)&&void 0!==h?h:globalThis.reactiveElementVersions=[]).push("1.2.1");const f=globalThis.trustedTypes,w=f?f.createPolicy("lit-html",{createHTML:t=>t}):void 0,b=`lit$${(Math.random()+"").slice(9)}$`,y="?"+b,m=`<${y}>`,$=document,_=(t="")=>$.createComment(t),k=t=>null===t||"object"!=typeof t&&"function"!=typeof t,x=Array.isArray,S=t=>{var i;return x(t)||"function"==typeof(null===(i=t)||void 0===i?void 0:i[Symbol.iterator])},C=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,A=/-->/g,M=/>/g,T=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,R=/'/g,E=/"/g,O=/^(?:script|style|textarea)$/i,P=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),U=P(1),N=P(2),z=Symbol.for("lit-noChange"),j=Symbol.for("lit-nothing"),L=new WeakMap,D=$.createTreeWalker($,129,null,!1),I=(t,i)=>{const s=t.length-1,e=[];let o,n=2===i?"<svg>":"",r=C;for(let i=0;i<s;i++){const s=t[i];let h,l,a=-1,c=0;for(;c<s.length&&(r.lastIndex=c,l=r.exec(s),null!==l);)c=r.lastIndex,r===C?"!--"===l[1]?r=A:void 0!==l[1]?r=M:void 0!==l[2]?(O.test(l[2])&&(o=RegExp("</"+l[2],"g")),r=T):void 0!==l[3]&&(r=T):r===T?">"===l[0]?(r=null!=o?o:C,a=-1):void 0===l[1]?a=-2:(a=r.lastIndex-l[2].length,h=l[1],r=void 0===l[3]?T:'"'===l[3]?E:R):r===E||r===R?r=T:r===A||r===M?r=C:(r=T,o=void 0);const d=r===T&&t[i+1].startsWith("/>")?" ":"";n+=r===C?s+m:a>=0?(e.push(h),s.slice(0,a)+"$lit$"+s.slice(a)+b+d):s+b+(-2===a?(e.push(void 0),i):d)}const h=n+(t[s]||"<?>")+(2===i?"</svg>":"");if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return[void 0!==w?w.createHTML(h):h,e]};class J{constructor({strings:t,_$litType$:i},s){let e;this.parts=[];let o=0,n=0;const r=t.length-1,h=this.parts,[l,a]=I(t,i);if(this.el=J.createElement(l,s),D.currentNode=this.el.content,2===i){const t=this.el.content,i=t.firstChild;i.remove(),t.append(...i.childNodes)}for(;null!==(e=D.nextNode())&&h.length<r;){if(1===e.nodeType){if(e.hasAttributes()){const t=[];for(const i of e.getAttributeNames())if(i.endsWith("$lit$")||i.startsWith(b)){const s=a[n++];if(t.push(i),void 0!==s){const t=e.getAttribute(s.toLowerCase()+"$lit$").split(b),i=/([.?@])?(.*)/.exec(s);h.push({type:1,index:o,name:i[2],strings:t,ctor:"."===i[1]?G:"?"===i[1]?Y:"@"===i[1]?q:Z})}else h.push({type:6,index:o})}for(const i of t)e.removeAttribute(i)}if(O.test(e.tagName)){const t=e.textContent.split(b),i=t.length-1;if(i>0){e.textContent=f?f.emptyScript:"";for(let s=0;s<i;s++)e.append(t[s],_()),D.nextNode(),h.push({type:2,index:++o});e.append(t[i],_())}}}else if(8===e.nodeType)if(e.data===y)h.push({type:2,index:o});else{let t=-1;for(;-1!==(t=e.data.indexOf(b,t+1));)h.push({type:7,index:o}),t+=b.length-1}o++}}static createElement(t,i){const s=$.createElement("template");return s.innerHTML=t,s}}function H(t,i,s=t,e){var o,n,r,h;if(i===z)return i;let l=void 0!==e?null===(o=s._$Cl)||void 0===o?void 0:o[e]:s._$Cu;const a=k(i)?void 0:i._$litDirective$;return(null==l?void 0:l.constructor)!==a&&(null===(n=null==l?void 0:l._$AO)||void 0===n||n.call(l,!1),void 0===a?l=void 0:(l=new a(t),l._$AT(t,s,e)),void 0!==e?(null!==(r=(h=s)._$Cl)&&void 0!==r?r:h._$Cl=[])[e]=l:s._$Cu=l),void 0!==l&&(i=H(t,l._$AS(t,i.values),l,e)),i}class B{constructor(t,i){this.v=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(t){var i;const{el:{content:s},parts:e}=this._$AD,o=(null!==(i=null==t?void 0:t.creationScope)&&void 0!==i?i:$).importNode(s,!0);D.currentNode=o;let n=D.nextNode(),r=0,h=0,l=e[0];for(;void 0!==l;){if(r===l.index){let i;2===l.type?i=new W(n,n.nextSibling,this,t):1===l.type?i=new l.ctor(n,l.name,l.strings,this,t):6===l.type&&(i=new F(n,this,t)),this.v.push(i),l=e[++h]}r!==(null==l?void 0:l.index)&&(n=D.nextNode(),r++)}return o}m(t){let i=0;for(const s of this.v)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++}}class W{constructor(t,i,s,e){var o;this.type=2,this._$AH=j,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cg=null===(o=null==e?void 0:e.isConnected)||void 0===o||o}get _$AU(){var t,i;return null!==(i=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==i?i:this._$Cg}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===t.nodeType&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=H(this,t,i),k(t)?t===j||null==t||""===t?(this._$AH!==j&&this._$AR(),this._$AH=j):t!==this._$AH&&t!==z&&this.$(t):void 0!==t._$litType$?this.T(t):void 0!==t.nodeType?this.S(t):S(t)?this.A(t):this.$(t)}M(t,i=this._$AB){return this._$AA.parentNode.insertBefore(t,i)}S(t){this._$AH!==t&&(this._$AR(),this._$AH=this.M(t))}$(t){this._$AH!==j&&k(this._$AH)?this._$AA.nextSibling.data=t:this.S($.createTextNode(t)),this._$AH=t}T(t){var i;const{values:s,_$litType$:e}=t,o="number"==typeof e?this._$AC(t):(void 0===e.el&&(e.el=J.createElement(e.h,this.options)),e);if((null===(i=this._$AH)||void 0===i?void 0:i._$AD)===o)this._$AH.m(s);else{const t=new B(o,this),i=t.p(this.options);t.m(s),this.S(i),this._$AH=t}}_$AC(t){let i=L.get(t.strings);return void 0===i&&L.set(t.strings,i=new J(t)),i}A(t){x(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const o of t)e===i.length?i.push(s=new W(this.M(_()),this.M(_()),this,this.options)):s=i[e],s._$AI(o),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e)}_$AR(t=this._$AA.nextSibling,i){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,!1,!0,i);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i}}setConnected(t){var i;void 0===this._$AM&&(this._$Cg=t,null===(i=this._$AP)||void 0===i||i.call(this,t))}}class Z{constructor(t,i,s,e,o){this.type=1,this._$AH=j,this._$AN=void 0,this.element=t,this.name=i,this._$AM=e,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=j}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,i=this,s,e){const o=this.strings;let n=!1;if(void 0===o)t=H(this,t,i,0),n=!k(t)||t!==this._$AH&&t!==z,n&&(this._$AH=t);else{const e=t;let r,h;for(t=o[0],r=0;r<o.length-1;r++)h=H(this,e[s+r],i,r),h===z&&(h=this._$AH[r]),n||(n=!k(h)||h!==this._$AH[r]),h===j?t=j:t!==j&&(t+=(null!=h?h:"")+o[r+1]),this._$AH[r]=h}n&&!e&&this.k(t)}k(t){t===j?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class G extends Z{constructor(){super(...arguments),this.type=3}k(t){this.element[this.name]=t===j?void 0:t}}const V=f?f.emptyScript:"";class Y extends Z{constructor(){super(...arguments),this.type=4}k(t){t&&t!==j?this.element.setAttribute(this.name,V):this.element.removeAttribute(this.name)}}class q extends Z{constructor(t,i,s,e,o){super(t,i,s,e,o),this.type=5}_$AI(t,i=this){var s;if((t=null!==(s=H(this,t,i,0))&&void 0!==s?s:j)===z)return;const e=this._$AH,o=t===j&&e!==j||t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive,n=t!==j&&(e===j||o);o&&this.element.removeEventListener(this.name,this,e),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var i,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(i=this.options)||void 0===i?void 0:i.host)&&void 0!==s?s:this.element,t):this._$AH.handleEvent(t)}}class F{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){H(this,t)}}const K={P:"$lit$",V:b,L:y,I:1,N:I,R:B,D:S,j:H,H:W,O:Z,F:Y,B:q,W:G,Z:F},Q=window.litHtmlPolyfillSupport;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const gt=vt(class extends pt{constructor(t){var i;if(super(t),t.type!==dt||"style"!==t.name||(null===(i=t.strings)||void 0===i?void 0:i.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((i,s)=>{const e=t[s];return null==e?i:i+`${s=s.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${e};`}),"")}update(t,[i]){const{style:s}=t.element;if(void 0===this.ct){this.ct=new Set;for(const t in i)this.ct.add(t);return this.render(i)}this.ct.forEach((t=>{null==i[t]&&(this.ct.delete(t),t.includes("-")?s.removeProperty(t):s[t]="")}));for(const t in i){const e=i[t];null!=e&&(this.ct.add(t),t.includes("-")?s.setProperty(t,e):s[t]=e)}return z}}),ft=t=>t.isPrimary&&("touch"===t.pointerType||t.pressure>0),wt=t=>"touch"!==t.pointerType&&t.isPrimary&&t.pressure>0,bt=t=>{t.preventDefault(),t.stopPropagation()},yt=(t,i)=>[t[0]+i[0],t[1]+i[1]],mt=(t,i)=>yt(t,[i,i]),$t=(t,i)=>[t[0]-i[0],t[1]-i[1]],_t=(t,i)=>[t[0]*i,t[1]*i],kt=(t,i)=>[t[0]*i[0],t[1]*i[1]],xt=(t,i)=>[t[0]/i[0],t[1]/i[1]],St=(t,i)=>[t[0]/i,t[1]/i],Ct=(t,i)=>[Math.max(t[0],i[0]),Math.max(t[1],i[1])],At=(t,i)=>[Math.min(t[0],i[0]),Math.min(t[1],i[1])],Mt=(t,i,s)=>Ct(t,At(i,s)),Tt=(t,i)=>t[0]===i[0]&&t[1]===i[1];let Rt=class extends it{constructor(){super(...arguments),this.scale=1,this.c_dim=[0,0],this.v_dim=[0,0],this.v_loc=[0,0],this._scrollPos=[0,0],this.smooth=0,this.#t=0,this.#i=[0,0],this.#s=new ResizeObserver((t=>{for(let i of t)switch(i.target){case this.surface:this.v_dim=[i.contentRect.width,i.contentRect.height];const t=this.getBoundingClientRect();this.v_loc=[t.x,t.y],this.smooth=0;break;case this.#e:this.c_dim=[this.#e.width.baseVal.value,this.#e.height.baseVal.value]}})),this.#o=t=>{t.ctrlKey&&("="===t.key?(bt(t),this.smooth=200,this._performZoom(this.coordToLocal(St(yt(this.v_loc,this.v_dim),2)),.2*this.scale)):"-"===t.key?(bt(t),this.smooth=200,this._performZoom(this.coordToLocal(St(yt(this.v_loc,this.v_dim),2)),-.2*this.scale)):"0"===t.key&&(this.smooth=100,this.#n()))},this.#r=[0,0],this.#h=t=>{bt(t),t.target.setPointerCapture(t.pointerId),this.#r=[t.clientX,t.clientY]},this.#l=(t,i,s,e)=>{this.smooth=0;let o=this.#a,n=this.#r;this.#r=[t.clientX,t.clientY],this.#a=[i?o[0]+e*(this.#r[0]-n[0]):o[0],s?o[1]+e*(this.#r[1]-n[1]):o[1]]},this.#c=t=>{t.target.releasePointerCapture(t.pointerId)},this._touchdragstart=t=>{t.isPrimary&&"touch"===t.pointerType&&this.#h(t)},this._touchdragmove=t=>{t.isPrimary&&"touch"===t.pointerType&&this.#l(t,!0,!0,-1)},this._touchdragend=t=>{t.isPrimary&&"touch"===t.pointerType&&this.#c(t)}}#e;get#a(){return Ct([0,0],At(this._scrollPos,$t(_t(this.c_dim,this.scale),this.v_dim)))}set#a(t){const i=this._scrollPos;this._scrollPos=t,this.requestUpdate("#scrollPos",i)}get offset(){return Ct([0,0],_t($t(this.v_dim,_t(this.c_dim,this.scale)),.5)).map((t=>t))}render(){const t=this.offset,i=this.#a;let s=!1,e=!1;this.v_dim&&this.c_dim&&(s=this.v_dim[1]<this.c_dim[1]*this.scale,e=this.v_dim[0]<this.c_dim[0]*this.scale);const o=xt(kt(this.v_dim,this.v_dim),_t(this.c_dim,this.scale)),n=xt(kt(i,this.v_dim),_t(this.c_dim,this.scale));return U`<style>:host,:root{--scale:${this.scale}}::slotted(svg){transform:translate(${t[0]-i[0]}px,${t[1]-i[1]}px) scale(var(--scale))}*,::slotted(svg){transition-duration:${this.smooth+"ms"}}</style><div id="touch-surface" @wheel="${this._wheel}" @pointerdown="${this._touchdragstart}" @pointermove="${this._touchdragmove}" @pointerup="${this._touchdragend}" @gesturestart="${this._gesturestart}" @gesturechange="${this._gesturechange}"><div id="bg" part="background"></div><slot @slotchange="${this.handleSlotchange}"></slot><div part="bar" class="bottombar" style="${gt({transform:`translate(${n[0]}px, 0)`,width:`${o[0]}px`,display:e?"block":"none"})}" @pointerdown="${this.#d}" @pointermove="${this.#u}" @pointerup="${this.#v}"></div><div part="bar" class="rightbar" style="${gt({transform:`translate(0, ${n[1]}px)`,height:`${o[1]}px`,display:s?"block":"none"})}" @pointerdown="${this.#d}" @pointermove="${this.#p}" @pointerup="${this.#v}"></div></div>`}#d(t){wt(t)&&this.#h(t)}#u(t){wt(t)&&this.#l(t,!0,!1,this.c_dim[0]*this.scale/this.v_dim[0])}#p(t){wt(t)&&this.#l(t,!1,!0,this.c_dim[1]*this.scale/this.v_dim[1])}#v(t,i){this.#c(t)}_wheel(t){bt(t);const i=t.deltaMode===WheelEvent.DOM_DELTA_LINE?10:1;if(t.ctrlKey){const s=.005*Math.min(50,Math.max(-50,-t.deltaY*i))*this.scale;this.smooth=Math.abs(s)>.05?20*Math.abs(s):0,this._performZoom(this.coordToLocal([t.clientX,t.clientY]),s)}else{const s=_t([t.deltaX,t.deltaY],i);this.smooth=2*(Math.abs(s[0])+Math.abs(s[1])),this.smooth=0,this.#a=yt(s,this.#a)}}#t;#i;_gesturestart(t){this.#i=this.coordToLocal([t.clientX,t.clientY]),this.#t=1,bt(t)}_gesturechange(t){bt(t),this._performZoom(this.#i,this.scale*(t.scale-this.#t)*1.5),this.#t=t.scale}_performZoom(t,i){let s=Math.min(2,Math.max(.2,this.scale+i)),e=s-this.scale;this.#a=yt(_t(t,e),this.#a),this.scale=s}#s;firstUpdated(){this.#s.observe(this.surface)}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.#o)}disconnectedCallback(){super.disconnectedCallback(),this.#s.disconnect(),document.removeEventListener("keydown",this.#o)}#o;coordToLocal(t){const i=yt($t(t,this.v_loc),this.#a);return St($t(i,this.offset),this.scale)}handleSlotchange({target:t}){this.#e&&this.#s.unobserve(this.#e),this.#e=t.assignedElements().find((t=>t.matches("svg"))),this.#n(),this.#e&&this.#s.observe(this.#e)}#n(){const t=[this.#e.width.baseVal.value,this.#e.height.baseVal.value],i=this.surface.getBoundingClientRect();this.scale=Math.max(.2,Math.min(2,..._t(xt([i.width,i.height],t),.95)))}#r;#h;#l;#c;static get styles(){return n`#touch-surface{position:relative;width:100%;height:100%;overflow:clip}::slotted(svg){transform-origin:0 0;position:absolute}.bottombar{position:fixed;bottom:0;height:var(--thickness);transform-origin:0 0;backface-visibility:hidden;will-change:width}.rightbar{position:fixed;width:var(--thickness);transform-origin:0 0;backface-visibility:hidden;right:0;will-change:height}*,::slotted(svg){transition-property:all}#bg{position:absolute;z-index:-1;height:100%;width:100%}`}};t([nt({type:Number})],Rt.prototype,"scale",void 0),t([rt()],Rt.prototype,"c_dim",void 0),t([rt()],Rt.prototype,"v_dim",void 0),t([rt()],Rt.prototype,"v_loc",void 0),t([rt()],Rt.prototype,"_scrollPos",void 0),t([at("#touch-surface",!0)],Rt.prototype,"surface",void 0),t([rt()],Rt.prototype,"smooth",void 0),t([lt({passive:!1,capture:!0})],Rt.prototype,"_wheel",null),t([lt({capture:!0})],Rt.prototype,"_gesturestart",null),t([lt({passive:!1})],Rt.prototype,"_gesturechange",null),Rt=t([et("bg-viewport")],Rt);const Et=()=>{document.documentElement.style.setProperty("--app-height",`${window.innerHeight}px`)};window.addEventListener("resize",Et),Et();
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const{H:Ot}=K,Pt=()=>document.createComment(""),Ut=(t,i,s)=>{var e;const o=t._$AA.parentNode,n=void 0===i?t._$AB:i._$AA;if(void 0===s){const i=o.insertBefore(Pt(),n),e=o.insertBefore(Pt(),n);s=new Ot(i,e,t,t.options)}else{const i=s._$AB.nextSibling,r=s._$AM,h=r!==t;if(h){let i;null===(e=s._$AQ)||void 0===e||e.call(s,t),s._$AM=t,void 0!==s._$AP&&(i=t._$AU)!==r._$AU&&s._$AP(i)}if(i!==n||h){let t=s._$AA;for(;t!==i;){const i=t.nextSibling;o.insertBefore(t,n),t=i}}}return s},Nt=(t,i,s=t)=>(t._$AI(i,s),t),zt={},jt=t=>{var i;null===(i=t._$AP)||void 0===i||i.call(t,!1,!0);let s=t._$AA;const e=t._$AB.nextSibling;for(;s!==e;){const t=s.nextSibling;s.remove(),s=t}},Lt=(t,i,s)=>{const e=new Map;for(let o=i;o<=s;o++)e.set(t[o],o);return e},Dt=vt(class extends pt{constructor(t){if(super(t),t.type!==ut)throw Error("repeat() can only be used in text expressions")}dt(t,i,s){let e;void 0===s?s=i:void 0!==i&&(e=i);const o=[],n=[];let r=0;for(const i of t)o[r]=e?e(i,r):r,n[r]=s(i,r),r++;return{values:n,keys:o}}render(t,i,s){return this.dt(t,i,s).values}update(t,[i,s,e]){var o;const n=(t=>t._$AH)(t),{values:r,keys:h}=this.dt(i,s,e);if(!Array.isArray(n))return this.at=h,r;const l=null!==(o=this.at)&&void 0!==o?o:this.at=[],a=[];let c,d,u=0,v=n.length-1,p=0,g=r.length-1;for(;u<=v&&p<=g;)if(null===n[u])u++;else if(null===n[v])v--;else if(l[u]===h[p])a[p]=Nt(n[u],r[p]),u++,p++;else if(l[v]===h[g])a[g]=Nt(n[v],r[g]),v--,g--;else if(l[u]===h[g])a[g]=Nt(n[u],r[g]),Ut(t,a[g+1],n[u]),u++,g--;else if(l[v]===h[p])a[p]=Nt(n[v],r[p]),Ut(t,n[u],n[v]),v--,p++;else if(void 0===c&&(c=Lt(h,p,g),d=Lt(l,u,v)),c.has(l[u]))if(c.has(l[v])){const i=d.get(h[p]),s=void 0!==i?n[i]:null;if(null===s){const i=Ut(t,n[u]);Nt(i,r[p]),a[p]=i}else a[p]=Nt(s,r[p]),Ut(t,n[u],s),n[i]=null;p++}else jt(n[v]),v--;else jt(n[u]),u++;for(;p<=g;){const i=Ut(t,a[g+1]);Nt(i,r[p]),a[p++]=i}for(;u<=v;){const t=n[u++];null!==t&&jt(t)}return this.at=h,((t,i=zt)=>{t._$AH=i})(t,a),z}}),It=async t=>{let i=t.dataTransfer?.items??[];return new Promise((async(t,s)=>{console.log("DataItems",i.length);for(let s=0;s<i.length;s++){if(console.log(i[s].type),i[s].type.startsWith("image/"))return t({blob:i[s].getAsFile()});if("text/html"===i[s].type)return void i[s].getAsString((i=>t(Jt(i))));if("application/x-moz-file-promise-url"===i[s].type)return void i[s].getAsString((t=>{}));if("string"===i[s].kind){let t=i[s].type;i[s].getAsString((i=>console.log(t,i)))}}return s("No compatible drop type found")}))};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Jt(t){const i=(new DOMParser).parseFromString(t,"text/html").querySelector("img")?.src;return i?{url:i}:null}const Ht=()=>([1e7]+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,(t=>(t^crypto.getRandomValues(new Uint8Array(1))[0]&15>>t/4).toString(16))),Bt=t=>new CustomEvent("game-event",{detail:t});class Wt{constructor(){this.index=[],this.all=()=>this.index.map((t=>[t,this.get(t)]))}get(t){return t.startsWith("local:")?window.sessionStorage.getItem(t):t}register(t,i){let s=i??"local:"+Ht();return this.index.push(s),window.sessionStorage.setItem(s,URL.createObjectURL(t)),s}}let Zt=class extends it{constructor(){super(),this.width=40,this.height=10,this.tokens=new Map([]),this.#g=0,this.#f=t=>{bt(t),this.#g++},this.#w=t=>{bt(t),this._drop_hint=Mt([0,0],_t([this.width-1,this.height-1],48),this.#b(t).map(Vt)),this.hovering="canvas"},this.#y=t=>{--this.#g<=0&&(this._drop_hint=void 0,this.hovering=void 0)},this.#m=t=>{bt(t),this._drop_hint=void 0,this.hovering="bg"},this.#$=async t=>{bt(t);try{const i=await It(t),s="blob"in i?this.resources.register(i.blob):i.url;this.bg=s,this.dispatchEvent(Bt({type:"bg",res:s})),"blob"in i&&this.dispatchEvent(Bt({type:"file",name:s,contents:i.blob}))}catch(t){}this.hovering=void 0},this.#_=async t=>{bt(t),console.log(t);try{const i=await It(t),s="blob"in i?this.resources.register(i.blob):i.url,e=Ht();this.tokens.set(e,{loc:this._drop_hint,dim:[48,48],id:e,res:s,r:0}),this.dispatchEvent(Bt({type:"token-added",loc:this._drop_hint,id:e,res:s})),"blob"in i&&this.dispatchEvent(Bt({type:"file",name:s,contents:i.blob}))}catch(t){}this._drop_hint=void 0,this.hovering=void 0},this.#k=t=>{t.preventDefault(),t.stopPropagation(),this.selection=t.target.id},this.#x=t=>{this.selection=void 0},this.#S=t=>{ft(t)&&(bt(t),t.target.setPointerCapture(t.pointerId),this.#C=this.#b(t))},this._selection_transform={move:[0,0],resize:[0,0],r:0},this.#A=t=>{if(!ft(t))return;this.#C||this.#S(t),bt(t);const i=Mt([0,0],[48*this.width,48*this.height],this.#b(t)),s=this.tokens.get(this.selection),e=s.dim,o=s.loc,n=t.target.classList;let r=[0,0],h=[0,0],l=0;if(n.contains("rn")&&(h[1]=o[1]-i[1],r[1]=Gt(i[1])-o[1]),n.contains("rw")&&(h[0]=o[0]-i[0],r[0]=Gt(i[0])-o[0]),n.contains("rs")&&(h[1]=Gt(i[1])-e[1]-o[1]),n.contains("re")&&(h[0]=Gt(i[0])-e[0]-o[0]),n.contains("ro")){const t=yt(o,St(e,2)),n=$t(i,t),r=180*Math.atan2(n[0],-n[1])/Math.PI;l=90*Math.round(r/90)-s.r%360}n.contains("selection-box")?r=$t(i,this.#C).map(Gt):(r=At(mt(e,-48),r),h=Ct(mt(_t(e,-1),48),h.map(Gt))),l===this._selection_transform.r&&Tt(r,this._selection_transform.move)&&Tt(h,this._selection_transform.resize)||(this._selection_transform={move:r,resize:h,r:l},this.dispatchEvent(Bt({type:"token-manipulated",id:s.id,loc:yt(s.loc,r),dim:yt(s.dim,h),r:s.r+l})))},this.#M=t=>{bt(t);const i=this.tokens.get(this.selection);i&&(i.loc=yt(i.loc,this._selection_transform.move),i.dim=yt(i.dim,this._selection_transform.resize),i.r+=this._selection_transform.r,console.log("el.r",i.r)),this._selection_transform={move:[0,0],resize:[0,0],r:0},this.#C=void 0},this.#b=t=>$t(this.viewport.coordToLocal([t.clientX,t.clientY]),[40,40]),this.#o=t=>{if(!this.selection)return;if(8===t.keyCode)return this.tokens.delete(this.selection),this.dispatchEvent(Bt({type:"token-removed",id:this.selection})),this.selection=void 0,void bt(t);let i=this.tokens.get(this.selection);let s={ArrowUp:[0,-48],ArrowDown:[0,48],ArrowLeft:[-48,0],ArrowRight:[48,0]}[t.key];s&&(i.loc=Mt([0,0],$t(this.#T,i.dim),yt(i.loc,s)),this.dispatchEvent(Bt({type:"token-manipulated",id:i.id,loc:i.loc,dim:i.dim,r:i.r})),this.requestUpdate(),bt(t))},this.get_state=()=>({type:"state-sync",tokens:[...this.tokens.values()],grid_dim:[this.width,this.height],bg:this.bg}),this.resources=new Wt}get#T(){return _t([this.width,this.height],48)}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.#o)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this.#o)}render(){let t,i,s,[e,o]=this.#T,n=this.tokens.get(this.selection);return n&&(i=yt(n.loc,this._selection_transform.move),t=yt(n.dim,this._selection_transform.resize),s=n.r+this._selection_transform.r),U`
      <bg-viewport
        @pointerup=${this.#x}
        @dragstart=${bt}
        @dragenter=${this.#f}
        ...
        @drop=${this.#_}
      >
        <svg id="root" width=${e+80} height=${o+80}>
          <defs>
            <clipPath id="canvasClip">
              <rect width=${e} height=${o} rx=${10}></rect>
            </clipPath>
            <pattern id="pat" x=${-.5} y=${-.5} width=${48} height=${48} patternUnits="userSpaceOnUse">
              <rect class="gridline" width=${1} height="100%" fill="#d3d3d3" opacity="1"></rect>
              <rect class="gridline" width="100%" height=${1} fill="#d3d3d3" opacity="1"></rect>
            </pattern>
          </defs>
          <g transform=${"translate(40 40)"}>
            <rect class="shadow" width=${e} height=${o} fill="white" rx=${10}></rect>
            <g style="clip-path: url(#canvasClip)">
              ${this.bg?N`<image href=${this.resources.get(this.bg)} width=${e} height=${o} preserveAspectRatio="none" />`:null}
              <rect width=${e} height=${o} fill="url(#pat)" opacity="0.75" pointer-events="none"></rect>

              ${Dt(this.tokens.values(),(t=>t.id),((e,o)=>{const n=this.resources.get(e.res),r=this.selection===e.id;let h=r?s:e.r;const l=(r?t[0]:e.dim[0])-1,a=(r?t[1]:e.dim[1])-1,c=(r?i[0]:e.loc[0])+.5,d=(r?i[1]:e.loc[1])+.5;return N`
          ...
          `:null}
            ...
            <g style=${`transform-origin: center; transform: rotate(${s}deg) translateY(${Math.sign((s-180)%180)*(t[0]-t[1])/2}px)`}>
              <line class="ro" x1="50%" x2="50%" y2=${-20}></line>
              <circle class="ro handle" cx="50%" cy=${-20} r=${4}></circle>
            </g>
