      ...
      >
        <svg id="root" width=${e+120} height=${o+120}>
          ...
          <svg x=${60} y=${60} width=${e} height=${o}>
            ...
            ${this.bg?N`<image href=${this.resources.get(this.bg)} width="100%" height="100%" preserveAspectRatio="none"></image>`:null}
